    ...
    AssessTransit.prototype.appendHtml = function (options) {
        ...
        try {
            assessSearchMap.transferSearch('公交站', options.distance, options, function (data) {
                var html = '<div id="select_transit_modal" class="modal fade bs-example-modal-lg" data-backdrop="static" tabindex="-1" role="dialog"aria-hidden="true">';
                html += ' <div class="modal-dialog modal-lg">';
                html += ' <div class="modal-content">';

                html += '<div class="modal-header">';
                html += '<h4 class="modal-title">公交站选择</h4>';
                ...
                html += "<input   name='radio' type='radio'   onclick='assessTransit.checkedFun(this,true)'>";
                html += "&nbsp;&nbsp;&nbsp;&nbsp;<span class='label label-primary'>" + '反选' + "</span>";
                html += "<input   name='radio' type='radio'   onclick='assessTransit.checkedFun(this,false)'>";
                ...
                html += '</button>';
                html += '<button type="button" class="btn btn-primary btn-sm" onclick="assessTransit.save(this)">';
                html += '保存</button>';
                html += '</div>';
