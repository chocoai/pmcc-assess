    ...
    AssessMatchingEducation.prototype.appendHtml = function (options) {
        ...
        try {
            assessSearchMap.otherSearch(options.type, options.distance, options, function (data) {
                var html = '<div id="select_matchingeducation_modal" class="modal fade bs-example-modal-lg" data-backdrop="static" tabindex="-1" role="dialog"aria-hidden="true">';
                html += ' <div class="modal-dialog modal-lg">';
                html += ' <div class="modal-content">';

                html += '<div class="modal-header">';
                html += '<h4 class="modal-title">教育机构选择</h4>';
                ...
                html += "<input name='radio' type='radio' onclick='assessMatchingEducation.checkedFun(this,true)'>";
                html += "&nbsp;&nbsp;&nbsp;&nbsp;<span class='label label-primary'>" + '反选' + "</span>";
                html += "<input name='radio' type='radio' onclick='assessMatchingEducation.checkedFun(this,false)'>";
                ...
                html += '</button>';
                html += '<button type="button" class="btn btn-primary btn-sm" onclick="assessMatchingEducation.save(this)">';
                html += '保存</button>';
                html += '</div>';
