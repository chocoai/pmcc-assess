...
(function ($) {
    ...
    AssessMatchingRecreation.prototype.appendHtml = function (options) {
        ...
        try {
            assessSearchMap.otherSearch(options.type, options.distance, options, function (data) {
                var html = '<div id="select_matchingRecreation_modal" class="modal fade bs-example-modal-lg" data-backdrop="static" ';
                ...
                html += '<h3 class="modal-title">休息娱乐选择 &nbsp;&nbsp;&nbsp;&nbsp;';
                ...
                html += "&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' class='btn btn-success' value='保存选中选项' onclick='assessMatchingRecreation.save(this)'>" ;
                html += "</h3>";
                html += '</div>';
    ...
    AssessMatchingRecreation.prototype.onSelected = function (this_) {
        ...
        AssessCommon.loadDataDicByKey(AssessDicKey.estate_distance, null, function (html, n) {
            ...
            var a2000Max = {};
            $.each(n, function (i, v) {
                var number = AssessMatchingRecreation.prototype.getNumber(v.name);
