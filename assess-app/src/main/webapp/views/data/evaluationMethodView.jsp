    ...
    function loadMethodList() {
        ...
        cols.push({
            field: 'id',  width: '5%',title: '操作', formatter: function (value, row, index) {
                ...
                str += '</button>';
                str += '<button onclick="removeData(' + row.id + ',\'tb_List\')"  style="margin-left: 5px;"  class="btn btn-icon btn-warning  btn-xs tooltips"  data-placement="bottom" data-original-title="删除">';
