...
<script type="text/javascript">
    ...
    sysFeedback.prototype = {
        ...
        loadDataDicList: function () {
            ...
            TableInit(sysFeedback.prototype.config().table, "${pageContext.request.contextPath}/sysFeedback/getMySysFeedbackList", cols, {
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" name="urgencyLevel">
                                                <option value="">--请选择--</option>
                                                <c:if test="${not empty valueTypeList}">
                                    ...
                                    <div class="x-valid">
                                        <label class="col-sm-1 control-label">
                                            反馈人<span class="symbol required"></span>
                                        </label>
                                        <div class="col-sm-3">
