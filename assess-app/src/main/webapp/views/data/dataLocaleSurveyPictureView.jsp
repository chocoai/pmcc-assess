...
<script type="text/javascript">
    ...
    dataProperty.prototype = {
        ...
        loadDataDicList: function (type) {
            ...
            TableInit(dataProperty.prototype.config().table, "${pageContext.request.contextPath}/dataLocaleSurveyPicture/getDataLocaleSurveyPictureList", cols, {
                type: type
            }, {
                showColumns: false,
                showRefresh: false,
        ...
        findList: function () {
            var type = $("#frmQuery").find("select[name='type']").val();
            dataProperty.prototype.loadDataDicList(type);
        },
