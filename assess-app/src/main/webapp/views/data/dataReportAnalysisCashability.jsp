                        ...
                        <form id="frmQuery" class="form-horizontal">
                            <div class="form-group ">
                                <div>
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" id="queryName" class="form-control input-full">
                                    </div>
                                </div>
                                &lt;%&ndash; <div>
                                     <label class="col-sm-1 control-label">类别</label>
                                     <div class="col-sm-2">
                                         <select class="form-control input-full" id="queryReportAnalysisType">
...
<script type="application/javascript">
    ...
    var type = "report_analysis_cashability";
