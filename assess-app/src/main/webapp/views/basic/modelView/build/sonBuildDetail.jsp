...
<%@include file="/views/project/stageSurvey/examine/residence/detail/buildingOutfit.jsp" %>

<div  id="industrySurface">
    <%@include file="/views/project/stageSurvey/examine/industry/detail/buildingSurface.jsp" %>
</div>
