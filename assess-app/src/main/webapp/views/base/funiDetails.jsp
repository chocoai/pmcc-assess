            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div class="col-sm-4 invoice-col">
                        <address>
                            <strong>项目地址:${funiHouses.xmdz}</strong>
                        </address>
                    </div>
                    <div class="col-sm-4 invoice-col">
                        <address>
                            <strong>区域:${funiHouses.lpdz}</strong>
                        </address>
                    </div>
                    <div class="col-sm-4 invoice-col">
                        <address>
                            <strong>开发商:${funiHouses.kfs}</strong>
                        </address>
                    </div>
                </div>
            </div>
                ...
                <div class="x_content">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <th>公交:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="gj_lppt_${funiHouses.id}" data-original-title='公交' class='editable editable-click'>${funiHousesMating.gj}</a>
                                </td>
                                <th>地铁:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="dt_lppt_${funiHouses.id}" data-original-title='地铁' class='editable editable-click'>${funiHousesMating.dt}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>幼儿园:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="yey_lppt_${funiHouses.id}" data-original-title='幼儿园' class='editable editable-click'>${funiHousesMating.yey}</a>
                                </td>
                                <th>小学:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="xx_lppt_${funiHouses.id}" data-original-title='小学' class='editable editable-click'>${funiHousesMating.xx}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>中学:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="zx_lppt_${funiHouses.id}" data-original-title='中学' class='editable editable-click'>${funiHousesMating.zx}</a>
                                </td>
                                <th>大学:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="dx_lppt_${funiHouses.id}" data-original-title='大学' class='editable editable-click'>${funiHousesMating.dx}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>医院:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="yy_lppt_${funiHouses.id}" data-original-title='医院' class='editable editable-click'>${funiHousesMating.yy}</a>
                                </td>
                                <th>药店:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="yd_lppt_${funiHouses.id}" data-original-title='药店' class='editable editable-click'>${funiHousesMating.yd}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>商场:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="sc_lppt_${funiHouses.id}" data-original-title='商场' class='editable editable-click'>${funiHousesMating.sc}</a>
                                </td>
                                <th>超市:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="cs_lppt_${funiHouses.id}" data-original-title='超市' class='editable editable-click'>${funiHousesMating.cs}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>市场:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="csc_lppt_${funiHouses.id}" data-original-title='市场' class='editable editable-click'>${funiHousesMating.csc}</a>
                                </td>
                                <th>银行:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="yh_lppt_${funiHouses.id}" data-original-title='银行' class='editable editable-click'>${funiHousesMating.yh}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>餐厅:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="ct_lppt_${funiHouses.id}" data-original-title='餐厅' class='editable editable-click'>${funiHousesMating.ct}</a>
                                </td>
                                <th>咖啡馆:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="kfg_lppt_${funiHouses.id}" data-original-title='咖啡馆' class='editable editable-click'>${funiHousesMating.kfg}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>电影院:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="dyy_lppt_${funiHouses.id}" data-original-title='电影院' class='editable editable-click'>${funiHousesMating.dyy}</a>
                                </td>
                                <th>公园:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="gy_lppt_${funiHouses.id}" data-original-title='公园' class='editable editable-click'>${funiHousesMating.gy}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>健身房:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="jsf_lppt_${funiHouses.id}" data-original-title='健身房' class='editable editable-click'>${funiHousesMating.jsf}</a>
                                </td>
                                <th>体育馆:</th>
                                <td colspan="3"><a href='#' data-type='textarea' name="tyg_lppt_${funiHouses.id}" data-original-title='体育馆' class='editable editable-click'>${funiHousesMating.tyg}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>楼盘介绍:</th>
                                <td colspan="7"><a href='#' data-type='textarea' name="lpjs_wyxx_${funiHouses.id}" data-original-title='楼盘介绍' class='editable editable-click'>${funiHouses.lpjs}</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                            <c:forEach var="item" items="${funiHousesPropertyList}">
                                <tr>
...
<script type="text/javascript">
    ...
    function updateFuniData(sName, paramsValue, xxType, id) {
        Loading.progressShow();
        $.ajax({
            url: "${pageContext.request.contextPath}/funiViewer/updateHousesData",
            type: "post",
            dataType: "json",
            data: {
                id: id,
