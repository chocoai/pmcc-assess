                        ...
                        <div class="panel">
                            <a class="panel-heading" role="tab" id="heading${activity.chksApprovalInfoVos.id}" data-toggle="collapse" data-parent="#accordion${activity.chksApprovalInfoVos.id}"
                               ...
                               aria-expanded="true" aria-controls="collapse${activity.chksApprovalInfoVos.id}">
                                <h4 class="panel-title">${activity.chksApprovalInfoVos.activityName}(考评)</h4>
                            </a>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="col-sm-4 col-sm-offset-5">
                        ...
                        <a class="btn btn-info" target="_blank" href="${pageContext.request.contextPath}/ChksAssess/details?processInsId=${processInsId}">
                            查看考核记录<i style="margin-left: 10px" class="fa fa-search"></i>
                        </a>
...
<script type="text/javascript">
    ...
    function saveform() {
        ...
        var clientData = formParams("frm_approval");
        clientData["formData"] = JSON.stringify(formData);
        $.ajax({
            url: "${pageContext.request.contextPath}/ChksAssess/approvalAssessResult",
            data: clientData,
            type: "post",
            dataType: "json",
