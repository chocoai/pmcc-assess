    ...
    (function () {
        ...
        houseRoom.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/deleteCaseHouseRoomById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            subclassSave: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/saveAndUpdateCaseHouseRoomDecorate",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            subclassRemoveData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/deleteCaseHouseRoomDecorateById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            subclassInit: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/examine_building_decorating_material",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/examine_building_material_price",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/examine_building_construction_technology",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/examine_building_decoration_part",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
            ...
            saveData: function () {
                ...
                data.houseId = '${empty caseHouse.id?0:caseHouse.id}' ;
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/saveAndUpdateCaseHouseRoom",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/getCaseHouseRoomById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseRoom/examine_unit_house_type",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
