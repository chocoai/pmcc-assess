    ...
    (function () {
        ...
        houseCorollaryEquipment.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseCorollaryEquipment/deleteCaseHouseCorollaryEquipmentById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseCorollaryEquipment/saveAndUpdateCaseHouseCorollaryEquipment",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseCorollaryEquipment/getCaseHouseCorollaryEquipmentById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseCorollaryEquipment/examine_house_corollary_equipment_price",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseCorollaryEquipment/examine_house_corollary_equipment_type",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseCorollaryEquipment/examine_house_corollary_equipment_category",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                FileUtils.uploadFiles({
                    ...
                    onUpload: function (file) {
                        var formData={
                            ...
                            tableName: AssessDBKey.CaseHouseCorollaryEquipment,
