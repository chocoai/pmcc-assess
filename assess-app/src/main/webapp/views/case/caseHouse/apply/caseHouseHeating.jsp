    ...
    (function () {
        ...
        houseHeating.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseEquipment/deleteCaseHouseEquipmentById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseEquipment/saveAndUpdateCaseHouseEquipment",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseEquipment/getCaseHouseEquipmentById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseEquipment/examine_house_equipment_price_range",
                    type: "get",
                    data: {type: houseHeating.prototype.config().type},
                    dataType: "json",
                    success: function (result) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseHouseEquipment/caseHouseEquipment_grade",
                    type: "get",
                    data: {type: houseHeating.prototype.config().type},
                    dataType: "json",
                    success: function (result) {
