    ...
    (function () {
        ...
        matchingEducation.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEducation/deleteCaseMatchingEducationById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEducation/saveAndUpdateCaseMatchingEducation",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEducation/getCaseMatchingEducationById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEducation/school_nature",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEducation/school_gradation",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEducation/school_level",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEducation/estate_distance",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
