    ...
    (function () {
        ...
        estateParking.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateParking/deleteCaseEstateParkingById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateParking/saveAndUpdateCaseEstateParking",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateParking/getCaseEstateParkingById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateParking/estate_car_type",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
