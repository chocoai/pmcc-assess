    ...
    (function () {
        ...
        matchingMaterial.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMaterial/deleteCaseMatchingMaterialById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMaterial/saveAndUpdateCaseMatchingMaterial",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMaterial/getCaseMatchingMaterialById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMaterial/estate_supply_new_distance",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMaterial/estate_supply_new_scale",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMaterial/estate_supply_new_type",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
