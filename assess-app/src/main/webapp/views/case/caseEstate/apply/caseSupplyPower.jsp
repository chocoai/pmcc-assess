    ...
    (function () {
        ...
        estateSupplyPower.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateSupply/deleteCaseEstateSupplyById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateSupply/saveAndUpdateCaseEstateSupply",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateSupply/getCaseEstateSupplyById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateSupply/line_water_supply_pipe_grade",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseEstateSupply/supplier_grade",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
