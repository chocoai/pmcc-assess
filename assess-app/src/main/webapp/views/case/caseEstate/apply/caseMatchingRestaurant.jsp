    ...
    (function () {
        ...
        matchingRestaurant.prototype = {
            ...
            viewInit: function () {
                ...
                if (matchingRestaurant.prototype.getFlag()) {
                    matchingRestaurant.prototype.init();
                    matchingRestaurant.prototype.setFlag(false);
                }
            },
            config: function () {
                var data = {};
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingLeisurePlace/deleteCaseMatchingLeisurePlaceById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingLeisurePlace/saveAndUpdateCaseMatchingLeisurePlace",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingLeisurePlace/getCaseMatchingLeisurePlaceById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingLeisurePlace/caseMatchingLeisurePlace_category",
                    type: "get",
                    data: {type: matchingRestaurant.prototype.config().type},
                    dataType: "json",
                    success: function (result) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingLeisurePlace/caseMatchingLeisurePlace_grade",
                    type: "get",
                    data: {type: matchingRestaurant.prototype.config().type},
                    dataType: "json",
                    success: function (result) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingLeisurePlace/caseMatchingLeisurePlace_distance",
                    type: "get",
                    data: {type: matchingRestaurant.prototype.config().type},
                    dataType: "json",
                    success: function (result) {
