    ...
    (function () {
        ...
        matchingEnvironment.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEnvironment/deleteCaseMatchingEnvironmentById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEnvironment/saveAndUpdateCaseMatchingEnvironment",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEnvironment/getCaseMatchingEnvironmentById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEnvironment/environment_category",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEnvironment/environment_type",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingEnvironment/environment_influence_degree",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                        ...
                        <div class="col-md-12">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        <label class="col-sm-2 control-label">
                                            环境类别<span class="symbol required"></span>
                                        </label>
                                        <div class="col-sm-10">
