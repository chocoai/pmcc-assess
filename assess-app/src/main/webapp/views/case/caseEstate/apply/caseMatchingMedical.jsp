    ...
    (function () {
        ...
        matchingMedical.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMedical/deleteCaseMatchingMedicalById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMedical/saveAndUpdateCaseMatchingMedical",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMedical/getCaseMatchingMedicalById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMedical/estate_examinematchingmedical_level",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseMatchingMedical/estate_examinematchingmedical_distance",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
