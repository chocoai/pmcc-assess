    ...
    (function () {
        ...
        unitHuxing.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitHuxing/deleteCaseUnitHuxingById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitHuxing/saveAndUpdateCaseUnitHuxing",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitHuxing/examine_unit_house_layout",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
