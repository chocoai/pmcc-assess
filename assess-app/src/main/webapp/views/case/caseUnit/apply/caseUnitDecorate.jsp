    ...
    (function () {
        ...
        unitDecorate.prototype = {
            ...
            removeData: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitDecorate/deleteCaseUnitDecorateById",
                    type: "post",
                    dataType: "json",
                    data: {id: id},
            ...
            saveData: function () {
                ...
                data.unitId = '${empty caseUnit.id?0:caseUnit.id}' ;
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitDecorate/saveAndUpdateCaseUnitDecorate",
                    type: "post",
                    dataType: "json",
                    data: data,
                    success: function (result) {
            ...
            getAndInit: function (id) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitDecorate/getCaseUnitDecorateById",
                    type: "get",
                    dataType: "json",
                    data: {id: id},
                    success: function (result) {
            ...
            init: function () {
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitDecorate/examine_building_decorating_material",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitDecorate/examine_building_material_price",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitDecorate/examine_building_construction_technology",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/caseUnitDecorate/examine_building_decoration_part",
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        if (result.ret) {
