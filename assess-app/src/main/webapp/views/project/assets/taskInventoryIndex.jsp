                    ...
                    <div class="x_title">
                        ...
                        <h3>申报编辑文件
                            <small><input type="button" class="btn btn-xs btn-primary" value="获取模板"
                                          onclick="inventory.writeDeclarationHtml(2);">
                            </small>
                        </h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="x-valid">
                                        <span class="input-group-btn"><input class="btn btn-warning" type="button" value="X"
                                                                             onclick="inventory.cleanItemHTML(this,'assetsCustomizeDataField_Fixed_file${item.id}',2,'${item.id}');"></span>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
                    ...
                    <div class="x_title">
                        ...
                        <h3>申报编辑字段
                            <small><input type="button" class="btn btn-xs btn-primary" value="获取配置字段"
                                          onclick="inventory.writeDeclarationHtml(1);">
                            </small>
                        </h3>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <div id="assetsCustomizeDataField_Fixed_fieldId">
                            <c:forEach items="${fixedDataField}" var="item">
                                <div class="form-group">
                                    ...
                                    <div class="x-valid">
                                        <span class="input-group-btn"><input class="btn btn-warning" type="button" value="X"
                                                                             onclick="inventory.cleanItemHTML(this,'assetsCustomizeDataField_Fixed${item.id}',1,'${item.id}');"></span>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="x-valid">
                                ...
                                <div class=" col-xs-11  col-sm-11  col-md-11  col-lg-11 ">
                                    <div class="btn  btn-success" onclick="inventory.writeDeclarationHtml(0)"><i class="fa fa-plus"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="assetsCustomizeDataOther_fieldId">
                            <c:forEach items="${customizeDataField}" var="item">
                                <div class="form-group">
                                    ...
                                    <div class="x-valid">
                                        <span class="input-group-btn"><input class="btn btn-warning" type="button" value="X"
                                                                             onclick="inventory.cleanItemHTML(this,'other_Enclosure${item.id}',0,'${item.id}');"></span>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.each(inventory.fileArray, function (i, n) {
            inventory.fileUpload2(n, AssessDBKey.ProjectPlanDetails, '${projectPlanDetails.id}', false,false, n);
