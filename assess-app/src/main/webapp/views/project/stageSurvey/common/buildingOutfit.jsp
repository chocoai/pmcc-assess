            ...
            <form class="form-horizontal">
                <p>
                    <button style="margin-left: 5px" class="btn btn-success btn-sm" type="button"
                            data-toggle="modal" onclick="buildingModelView.prototype.sonModelMethod.buildingOutfit.showModel()"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="buildingModelView.prototype.sonModelMethod.buildingOutfit.saveData()">
                    保存
                </button>
            </div>
