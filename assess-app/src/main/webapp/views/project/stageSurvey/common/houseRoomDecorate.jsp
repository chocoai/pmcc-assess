                                        ...
                                        <div class="form-inline x-valid">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    <input type="text" placeholder="装修部位" required
                                                           name="decoratePart"
                                                           class="form-control">
                                                    <div class="input-group-prepend">
                                                        <button class="btn btn-primary btn-sm "
                                                                ...
                                                                type="button"
                                                                onclick="houseRoomDecorate.prototype.openDecoratePartModal(this);">
                                                            编辑
                                                        </button>
                                                    </div>
                                                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="houseRoomDecorate.prototype.saveDecoratePart()">
                    保存
                </button>
            </div>
