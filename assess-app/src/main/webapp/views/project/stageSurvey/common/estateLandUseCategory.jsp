    ...
    <tr class="group">
        ...
        <td>
            <select class="form-control input-full" name="landLevelGrade"
                    onchange="landLevel.landLevelHandle(this);">
                {landLevelGradeHTML}
            </select>
        </td>
        <td>
        ...
        <td>
            <input class="btn btn-warning" type="button" value="X"
                   onclick="landLevel.landLevelEmpty(this)">
        </td>
    </tr>
</script>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm"
                        onclick="landLevel.saveLandLevelTabContent()">
                    保存
                </button>
            </div>
...
<script type="text/javascript">
    ...
    landLevel.saveLandLevelTabContent = function () {
        ...
        if (landLevel.option) {
            ...
            group.find("input[name=landFactorTotalScore]").val(landFactorTotalScoreResult);
