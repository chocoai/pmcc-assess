            ...
            <form class="form-horizontal">
                <p>
                    <button style="margin-left: 5px" class="btn btn-success btn-sm" type="button"
                            data-toggle="modal" onclick="houseNewWind.prototype.showModel()"
                            href="#divBoxHouseNewWind">
...
<div id="divBoxHouseNewWind" class="modal fade bs-example-modal-lg" data-backdrop="static" tabindex="-1"
     role="dialog"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">新风情况</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="houseNewWind.prototype.saveData()">
                    保存
                </button>
            </div>
