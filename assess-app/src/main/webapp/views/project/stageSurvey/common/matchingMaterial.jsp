...
<div class="col-md-12" id="industryMaterial">
            ...
            <form class="form-horizontal">
                <p>
                    <button style="margin-left: 5px" class="btn btn-success btn-sm" type="button"
                            data-toggle="modal" onclick="matchingMaterial.prototype.showModel()"
                            href="#divBoxMatchingMaterial">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">原料供应及销售条件</h4>
                                    ...
                                    <div class="form-inline x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="scale"
                                                    class="form-control input-full search-select select2 scale">
                                            </select>
                                        </div>
                                    </div>
                                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="matchingMaterial.prototype.saveData()">
                    保存
                </button>
            </div>
