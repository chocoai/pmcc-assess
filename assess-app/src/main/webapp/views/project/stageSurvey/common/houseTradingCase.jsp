                    ...
                    <div class="card-title">
                        <div class="form-inline">
                            ...
                            <button href="javascript://;" class="btn btn-sm btn-warning" type="button"
                                    ...
                                    onclick="houseTrading.saveHouseTrading(true,'basicHouseTradingFrm_number');">
                                <small>保存</small>
                            </button>
                            <button type="button" href="javascript://;" class="btn btn-sm btn-warning"
                                    onclick="houseTrading.cleanHTMLData(this)" style="margin-left: 5px">
                                <small>移除</small>
                            </button>
                        ...
                        <div class="col-md-12">
                            <div class="form-inline x-valid">
                                ...
                                <label class="col-sm-1">价格类型<span
                                        class="symbol required"></span></label>
                                <div class="col-sm-3">
                                    <select class="form-control input-full priceType"
                                            name="priceType"
                                            required>
                                    </select>
                                </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <div class="form-inline x-valid">
                                ...
                                <label class="col-sm-1 installmentInterestRate">分期支付利率</label>
                            ...
                            <div class="form-inline x-valid">
                                <div class="col-sm-1" style="text-align: right;">
                                    <button type="button"
                                            ...
                                            data-toggle="modal"
                                            onclick="houseTrading.addTradingSellAndLease('_number')"> <span
                                            class="btn-label">
...
<script type="application/javascript">
        ...
        if (!flag) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.ret) {
                        var html = $("#" + houseTrading.basicHouseTradingDiv).html();
                        var index = $("#" + houseTrading.basicHouseTradingAppend).find('.form-horizontal').length;
    ...
    houseTrading.initBasicHouseTradingForm = function (data, number) {
        ...
        houseTrading.changeEvent(data, number);
        if (data != null) {
    ...
    //下拉框change事件
    houseTrading.changeEvent = function (basicHouseTrading, number) {
        var houseTradingFormId = houseTrading.basicHouseTradingFrm + number;
        ...
        if (!readonly) {
            cols.push({
                field: 'id', title: '操作', formatter: function (value, row, index) {
                    ...
                    str += "<a class='btn btn-xs btn-warning tooltips' data-placement='top' data-original-title='删除' " + "onclick=houseTrading.deleteTradingSellAndLease(" + row.id + ",'" + tradingType + "','" + number + "'" + ")" + ">";
    ...
    //保存出售或出租
    houseTrading.saveTradingSellAndLease = function (_this) {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.ret) {
                    ...
                    houseTrading.loadTradingSellAndLeaseList(data.type, false, number);
                } else {
    ...
    //删除出售或出租
    houseTrading.deleteTradingSellAndLease = function (id, type, number) {
        $.ajax({
            ...
            success: function (result) {
                if (result.ret) {
                    ...
                    houseTrading.loadTradingSellAndLeaseList(type, false, number);
                } else {
                    AlertError("失败", "调用服务端方法失败，失败原因:" + result.errmsg);
                }
            },
     ...
     * @param _this
     */
    houseTrading.cleanHTMLData = function (_this) {
     ...
     * @returns {boolean}
     */
    houseTrading.saveHouseTrading = function (flag, _this) {
        if (flag) {
            //单个保存
    ...
    //新增出售或出租
    houseTrading.addTradingSellAndLease = function (number) {
        var houseTradingFormId = houseTrading.basicHouseTradingFrm + number;
    ...
    //附件上传
    houseTrading.fileUpload = function (fieldsName, number) {
        ...
        FileUtils.uploadFiles({
            ...
            onUploadComplete: function () {
                houseTrading.fileShow(fieldsName, number);

            }
        });
    };

    houseTrading.fileShow = function (fieldsName, number, deleteFlag) {
        var itemId = fieldsName + number;
    ...
    houseTrading.init = function () {
        $("#" + houseTrading.basicHouseTradingAppend).empty();
        houseTrading.appendHtml(true);
    }

    houseTrading.updateBisMark = function (_form, _this) {
