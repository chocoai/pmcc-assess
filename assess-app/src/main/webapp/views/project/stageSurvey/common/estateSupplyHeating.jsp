...
<div class="col-md-12" id="industrySupplyHeating"  tab-role="base">
            ...
            <form class="form-horizontal">
                <p>
                    <button style="margin-left: 5px" class="btn btn-success btn-sm" type="button"
                            data-toggle="modal" onclick="estateSupplyHeating.prototype.showModel()"
                            href="#divBoxEstateSupplyHeating">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="estateSupplyHeating.prototype.saveData()">
                    保存
                </button>
            </div>
