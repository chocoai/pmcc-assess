    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="x-valid" style="display: none">
                ...
                <div class=" col-xs-3  col-sm-3  col-md-3  col-lg-3 ">
                    <select class="form-control search-select select2 supplyCommunication" name="supplyCommunication">
                    </select>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="x-valid" style="display: none">
                <label class=" col-xs-1  col-sm-1  col-md-1  col-lg-1  control-label">道路情况</label>
                <div class=" col-xs-3  col-sm-3  col-md-3  col-lg-3 ">
                    <select class="form-control search-select select2 supplyRoad" name="supplyRoad">
                    </select>
                </div>
            </div>
        </div>
