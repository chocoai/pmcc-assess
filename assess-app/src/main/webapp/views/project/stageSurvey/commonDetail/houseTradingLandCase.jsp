                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <div class="form-inline x-valid">
                                ...
                                <label class="col-sm-1 control-label">每亩单价</label>
                                <div class="col-sm-3">
                                    <label class="form-control input-full"
                                           name="perMuPrice"></label>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="application/javascript">
    ...
    houseLandTrading.initBasicHouseTradingForm = function (data, number) {
        ...
        if (data != null) {
            ...
            houseLandTrading.showTradingCondition(data, number);
            houseLandTrading.showInformationType(data, number);
            houseLandTrading.showTradingSellOrLeaese(data, number);
            houseLandTrading.showTransactionSituation(data, number);
            ...
            $.each(houseLandTrading.houseFileControlIdArray, function (i, item) {
                houseLandTrading.fileShow(item, number);
            });
    ...
    houseLandTrading.showTransactionSituation = function (data, number) {
        var houseTradingFormId = houseLandTrading.basicHouseTradingFrm + number;
    ...
    houseLandTrading.showTradingCondition = function (data, number) {
        var houseTradingFormId = houseLandTrading.basicHouseTradingFrm + number;
    ...
    houseLandTrading.showInformationType = function (data, number) {
        var houseTradingFormId = houseLandTrading.basicHouseTradingFrm + number;
    ...
    houseLandTrading.showTradingSellOrLeaese = function (data, number) {
        var houseTradingFormId = houseLandTrading.basicHouseTradingFrm + number;
    ...
    houseLandTrading.fileShow = function (fieldsName, number) {
