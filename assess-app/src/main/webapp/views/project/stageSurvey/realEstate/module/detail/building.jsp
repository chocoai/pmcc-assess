                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" id="basicBuildingFrm">
                                    ...
                                    <div class="row form-group"  style="display: none;">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                <div class="col-sm-3" tab-role="base" >
                                    ...
                                    <div class="row form-group" tab-role="base">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="floorHeight">${basicBuilding.floorHeight}</label>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="buildingHeight">${basicBuilding.buildingHeight}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row form-group" tab-role="method">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="buildingArea">${basicBuilding.buildingArea}</label>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="coverAnArea">${basicBuilding.coverAnArea}</label>
                                                </div>
                                                <label class="col-sm-1 control-label">
                                                    土地使用年限
                                                </label>
                                    ...
                                    <div class="row form-group"  tab-role="base">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                ...
                                                <div class="col-md-3"  >
                                                    <label class="form-control input-full">${basicBuilding.appearanceStyleName}</label>
                                                </div>
                                                ...
                                                <div   class="col-md-3">
                                                    <label class="form-control input-full">${basicBuilding.unitCount}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group" tab-role="method">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                ...
                                                <div class="col-md-3"  >
                                                    <label class="form-control input-full"
                                                           name="facilitiesUseFee">${basicBuilding.facilitiesUseFee}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group"  tab-role="base">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="betweenDistanceName">${basicBuilding.betweenDistanceName}</label>
                                                </div>
                                    ...
                                    <div class="row form-group" tab-role="method">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="builderName">${basicBuilding.builderName}</label>
                                                </div>
                                                <label class="col-sm-1 control-label">
                                                    物业费(平方米)
                                                </label>
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="propertyFee">${basicBuilding.propertyFee}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row form-group" tab-role="method">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="propertyName">${basicBuilding.propertyName}</label>
                                                </div>
