                            ...
                            <div class="card-body">
                                ...
                                <form id="frm_estate" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <div class="form-inline x-valid">
                                                <label tab-role="base" class="col-sm-1 control-label">楼盘名称</label>
                                                ...
                                                <label tab-role="base" class="col-sm-1 control-label">楼盘方位</label>
                                                <div tab-role="base" class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="positionName">${basicEstate.positionName}</label>
                                                </div>
                                                <label tab-role="base" class="col-sm-1 control-label">总楼栋数</label>
                                                <div tab-role="base" class="col-sm-3">
                                                    <label class="form-control input-full"
                                                           name="buildingNumber">${basicEstate.buildingNumber}</label>
                                                </div>

                                                <label tab-role="report" class="col-sm-1 control-label">基础版块<span
                                    ...
                                    <div tab-role="base" class="x_content">
