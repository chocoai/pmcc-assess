                            ...
                            <div class="card-body">
                                <form id="frmQuery" class="form-horizontal">
                                    <div class="form-group form-inline">
                                        ...
                                        <div class="col-md-2 p-0">
                                            <input type="text" data-rule-maxlength="50"
                                                   placeholder="项目名称"  name="projectName" class="form-control input-full">
                                        </div>
                                        ...
                                        <div class="col-md-2 p-0">
                                            ...
                                            <input type="text"  readonly="readonly" onclick="selectCreate(this)"
                                                   placeholder="项目经理"  name="queryManagerName" class="form-control input-full" data-title="name">
                                        </div>
                                    </div>
                                    <div class="form-group form-inline">
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        <div class="col-md-2 p-0">
                                            <input type="text"
                                                   placeholder="单位" class="form-control input-full" name="queryUseUnitName">
                                        </div>
                                        <label class="col-md-1 col-form-label">评估部门</label>
                                        <div class="col-md-2 p-0">
                                            <input  name="queryDepartmentId" class="form-control input-full" type="hidden" />
                                            <input  name="queryDepartmentName" class="form-control input-full" placeholder="评估部门"
                                ...
                                <table class="table table-bordered" id="tb_projectList">
