    ...
    <form id="frm_project_info" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="x-valid">
                ...
                <div class=" col-xs-3  col-sm-3  col-md-3  col-lg-3 ">
                    <select name="propertyScope" class="form-control search-select select2 propertyScope" onchange="$(this).closest('.form-group').find('[name=propertyScopeName]').val($(this).find('option:selected').text())">
                    </select>
        ...
        <div class="form-group">
            <div class="x-valid">
                <label class=" col-xs-1  col-sm-1  col-md-1  col-lg-1  control-label">业务来源<span
                        class="symbol required"></span></label>
                <div class=" col-xs-3  col-sm-3  col-md-3  col-lg-3 ">
                    <select name="serviceComeFrom" class="form-control search-select select2" required="required">
                    </select>
                </div>
            </div>
            <div class="x-valid">
            ...
            <div class="x-valid">
                ...
                <div class=" col-xs-3  col-sm-3  col-md-3  col-lg-3 ">
                    <input id="attachmentProjectInfoId" name="attachmentProjectInfoId"
                            placeholder="上传附件" class="form-control" type="file">
