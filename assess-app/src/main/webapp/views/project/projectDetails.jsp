                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 pull-right" style="margin: 0px">
                        ...
                        <c:if test="${projectStatusEnum=='normal'}">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="/pmcc-hr/HrBase/ApplyIndex/${legwork}/${projectInfo.publicProjectId}" target="_blank">外勤</a>
                                        <a href="/pmcc-hr/HrBase/ApplyIndex/${overtime}/${projectInfo.publicProjectId}" target="_blank">加班</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="/pmcc-finance/FinancialBase/ApplyIndex/${expense}/${projectInfo.publicProjectId}" target="_blank">费用报销</a>
                                        <a href="/pmcc-finance/FinancialBase/ApplyIndex/${pay}/${projectInfo.publicProjectId}" target="_blank">项目走款</a>
                                        <a href="/pmcc-finance/FinancialBase/ApplyIndex/${pettyCash}/${projectInfo.publicProjectId}" target="_blank">项目借款</a>
                                        <a href="/pmcc-finance/FinancialBase/ApplyIndex/${bill}/${projectInfo.publicProjectId}" target="_blank">开发票</a>
                                        <a href="/pmcc-finance/FinancialBase/ApplyIndex/${receivables}/${projectInfo.publicProjectId}" target="_blank">到账确认</a>
                                        <a href="/pmcc-finance/FinancialBase/ApplyIndex/${strikeBalance}/${projectInfo.publicProjectId}" target="_blank">冲账</a>
                                    </li>
                                </ul>
                            </div>
                        </c:if>
...
<script type="application/javascript">
    ...
    function addWorkLog() {
        ...
        $("#title").val("");
        $("#content").val("");
        $("#projectIds").val("${projectInfo.id}");
        $("#projectNames").val("${projectInfo.projectName}");
        $("#_file_upload").html("");
        $('#workLog').modal({
            backdrop: 'static'
        });
