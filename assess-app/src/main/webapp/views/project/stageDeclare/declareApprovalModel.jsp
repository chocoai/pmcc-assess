    ...
    <div id="declareModelHandleHouse">
        ...
        <div class="form-group">
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <label class="form-control" name="useStartDateFmt"></label>
        ...
        <div class="form-group">
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <label class="form-control" name="useEndDateFmt"></label>
        ...
        <div class="form-group">
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" name="terminationDateFmt" class="form-control" readonly="readonly">
                </div>
            </div>
            <div class="x-valid">
...
<script id="declareModelRealEstateCert" type="text/html" data-title="不动产证label">
    <div id="declareModelHandleRealEstateCert">
        ...
        <div class="form-group">
            ...
            <div class="x-valid">
                <label class="col-sm-1 control-label">权利性质</label>
                <div class="col-sm-3">
        ...
        <div class="form-group">
            ...
            <div class="x-valid">
                <label class="col-sm-1 control-label">共用宗地面积<span
                        class="symbol required"></span></label>
                <div class="col-sm-3">
                    <label class="form-control" name="useRightArea"></label>
                </div>
