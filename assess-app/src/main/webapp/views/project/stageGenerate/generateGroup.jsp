...
<div class="col-md-12">
    <div class="card full-height">
        ...
        <div class="card-body">
            <table class="table table-bordered" id="selectedJudgeObjectList"></table>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <div class="form-inline x-valid">
                            ...
                            <div class="col-sm-2">
                                <button type="button" class="btn-dark btn btn-sm" onclick="reportGroupObj.generateReport('${reportType.id}','{id}')">生成<i class="fa fa-file-word-o"></i></button>
                                <button type="button" class="btn-primary btn btn-sm" onclick="reportGroupObj.getReportNumber('${reportType.id}','{id}')">上传报告<i class="fa fa-dot-circle-o"></i></button>
                                <button type="button" class="btn-primary btn btn-sm" onclick="reportGroupObj.getReportNumber('${reportType.id}','{id}')">拿号<i class="fa fa-dot-circle-o"></i></button>
                            </div>
                            <label class="col-sm-1 control-label">
                                归档报告
                            </label>
                            ...
                            <div class="col-sm-2">
                                <button type="button" class="btn-dark btn btn-sm" onclick="reportGroupObj.generateReportAttachment('${reportType.id}','{id}')">生成附件<i class="fa fa-file-word-o"></i></button>
                            </div>
                            <label class="col-sm-1 control-label">
                                归档报告附件
                            </label>
