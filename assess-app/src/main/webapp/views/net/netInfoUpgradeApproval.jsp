...
<script type="text/javascript">
    function saveform() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/netInfoUpgrade/approvalCommit",
            type: "post",
            dataType: "json",
            data: data,
    ...
    detailInfo.prototype = {
        loadDataHouseList: function () {
            ...
            TableInit("house_list", "${pageContext.request.contextPath}/netInfoUpgrade/houseList", cols, {
        ...
        loadDataLandList: function () {
            ...
            TableInit("land_list", "${pageContext.request.contextPath}/netInfoUpgrade/landList", cols, {
                id: '${netInfoUpgrade.dataId}',
                applyId:'${netInfoUpgrade.id}'
            }, {
                showColumns: false,
