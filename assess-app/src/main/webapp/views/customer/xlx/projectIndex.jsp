                ...
                <div class="row mt--2">
                    ...
                    <div class="col-md-12">
                        <div class="card full-height">
                            ...
                            <%@include file="./stageInitModel/projectInfo.jsp" %>
                        </div>
                    </div>
                    <!-- 委托人 start -->
                    <div class="col-md-12">
                        <div class="card full-height">
                            ...
                            <%@include file="./stageInitModel/projectConsignor.jsp" %>
                        </div>
                    </div>
                    <!-- 占有人 start -->
                    <div class="col-md-12">
                        <div class="card full-height">
                            ...
                            <%@include file="./stageInitModel/projectPossessor.jsp" %>
                        </div>
                    </div>
                    <!-- 报告使用单位 start -->
                    <div class="col-md-12">
                        <div class="card full-height">
                            ...
                            <%@include file="./stageInitModel/projectUnit_information.jsp" %>
