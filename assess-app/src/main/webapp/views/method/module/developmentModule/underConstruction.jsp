    ...
    <div class="x_content">
            ...
            <div class="x-valid">
                <div class="col-sm-11">
                    <input type="text"
                           ...
                           required="required"
                           name="f20" onblur="underConstruction.calculationD20()" value="${mdDevelopment.f20}">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="x-valid">
                <div class="col-sm-11">
                    <input type="text"
                           placeholder="不可预见费率" class="form-control x-percent" name="f27" onblur="underConstruction.calculationD27()"   value="${mdDevelopment.f27}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text"
                           ...
                           name="f29" onblur="underConstruction.calculationD28()" value="${mdDevelopment.f29}">
                </div>
            </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text"
                           ...
                           name="f30" onblur="underConstruction.calculationD28()"  value="${mdDevelopment.f30}">
                </div>
            </div>
            <div class="x-valid">
                <label class="col-sm-1 control-label">
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text"
                           ...
                           name="g32" onblur="underConstruction.calculationD32();underConstruction.calculationF32()"  value="${mdDevelopment.g32}">
                </div>
            </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text"
                           ...
                           name="g33" onblur="underConstruction.calculationF33()"  value="${mdDevelopment.g33}">
                </div>
            </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="投资利息率" class="form-control x-percent" required="required"
                           name="g34" onblur="underConstruction.calculationD34();underConstruction.calculationF34()"  value="${mdDevelopment.g34}">
                </div>
            </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="续建投资利润（万元）" class="form-control x-percent" required="required"
                           name="g35" onblur="underConstruction.calculationD35();underConstruction.calculationF35()"  value="${mdDevelopment.g35}">
                </div>
            </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="销售环节增值税及附加" class="form-control x-percent" required="required"
                           name="f37" onblur="underConstruction.calculationD36()"  value="${mdDevelopment.f37}">
                </div>
            </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="土地增值税" class="form-control x-percent" required="required"
                           name="f38" onblur="underConstruction.calculationD36()"  value="${mdDevelopment.f38}">
                </div>
            </div>
            ...
            <div class="x-valid">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="项目开发所得税" class="form-control x-percent" required="required"
                           name="f39" onblur="underConstruction.calculationD36()"  value="${mdDevelopment.f39}">
                </div>
            </div>
