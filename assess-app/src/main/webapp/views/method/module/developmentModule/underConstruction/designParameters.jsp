        ...
        <form class="form-horizontal" name="designParameters">
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text"
                               placeholder="契税率" class="form-control x-percent" readonly="readonly" data-rule-number='true' required="required"
                               name="deedTax">
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text"
                               placeholder="交易费率" readonly="readonly" class="form-control x-percent" data-rule-number='true' required="required"
            ...
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text"
                               placeholder="续建管理费率" readonly="readonly" class="form-control x-percent" data-rule-number='true' required="required"
            ...
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text"
                               placeholder="增值税金及附加率" class="form-control x-percent" data-rule-number='true' required="required"
