        ...
        <form class="form-horizontal" name="designParameters">
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="契税率" class="form-control x-percent"  required="required" name="deedTax">
                    </div>
                </div>
                ...
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="费率说明" class="form-control" name="deedTaxExplain">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="交易费率" class="form-control x-percent" required="required" name="transactionCostTax">
                    </div>
                </div>
                ...
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="费率说明" class="form-control" name="transactionCostTaxExplain">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="续建管理费率" class="form-control x-percent" required="required" name="managementExpenseTax">
                    </div>
                </div>
                ...
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="费率说明" class="form-control" name="managementExpenseTaxExplain">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="x-valid">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="销售费用率" class="form-control x-percent"  required="required" name="salesFeeTax">
                    </div>
                </div>
