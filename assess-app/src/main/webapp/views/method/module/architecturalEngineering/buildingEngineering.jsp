...
<%--var buildingEngineering = new Object();--%>
<%--buildingEngineering.isNotNull = function (obj) {--%>
<%--if (obj == 0) {--%>
<%--return true;--%>
<%--}--%>
<%--if (obj == '') {--%>
...
<%--return false;--%>
<%--};--%>
<%--buildingEngineering.config = function () {--%>
<%--return {--%>
<%--tableId: "buildingEngineeringID",--%>
...
<%--* @date: 2018-08-23--%>
<%--**/--%>
<%--buildingEngineering.loadData = function () {--%>
<%--var data = $('#' + buildingEngineering.config().tableId).treegrid('getData');--%>
<%--return data;--%>
<%--};--%>
...
<%--* @date:2018-08-23--%>
<%--**/--%>
<%--buildingEngineering.setServerData = function (data) {--%>
<%--this.data = data;--%>
<%--};--%>
<%--buildingEngineering.setArea = function (data) {--%>
<%--$('.' + buildingEngineering.config().areaClass).html(data);--%>
<%--};--%>
<%--buildingEngineering.getColumns = function () {--%>
<%--var data = null;--%>
<%--var precision = 2;//精度--%>
<%--data = [[--%>
...
<%--buildingEngineering.treeGrIdInit = function (data) {--%>
<%--$('#' + buildingEngineering.config().tableId).treegrid({--%>
<%--iconCls: 'icon-edit',--%>
<%--nowrap: false,--%>
<%--width: 1000,--%>
<%--height: 'auto',--%>
...
<%--fitColumns: true,--%>
<%--striped: true,//显示斑马线--%>
<%--columns: buildingEngineering.getColumns(),--%>
<%--onAfterEdit: function (row, changes) {//在用户完成编辑一行的时候触发--%>
<%--//根据id获取值--%>
<%--buildingEngineering.updateChildren($('#' + buildingEngineering.config().tableId).treegrid('find', row.id), changes);--%>
<%--}--%>
<%--});--%>
<%--};--%>
...
<%--* @date:2018-08-13--%>
<%--**/--%>
<%--buildingEngineering.init = function () {--%>
...
<%--console.log("引用修改数据!");--%>
<%--buildingEngineering.treeGrIdInit(data);--%>
...
<%--* @date:2018-08-13--%>
<%--**/--%>
<%--buildingEngineering.updateChildren = function (data, changes) {--%>
<%--if (buildingEngineering.isNotNull(data)) {--%>
<%--var currency = null;--%>
...
<%--}--%>
<%--}--%>
<%--if (buildingEngineering.isNotNull(currency)) {--%>
<%--//更新节点值--%>
<%--$('#' + buildingEngineering.config().tableId).treegrid('update', {--%>
<%--id: data.id,--%>
<%--row: {currency: currency}--%>
<%--});--%>
<%--if (!data.parent) {//说明不是父节点--%>
<%--buildingEngineering.updateFather(data);--%>
<%--} else {--%>
<%--buildingEngineering.updateDirectFather();--%>
<%--}--%>
<%--}--%>
<%--}--%>
<%--};--%>

<%--buildingEngineering.updateDirectFather = function () {--%>
<%--//更新建安成本小计--%>
<%--buildingEngineering.totalCalculation();--%>
<%--};--%>
...
<%--* @date:2018-08-13--%>
<%--**/--%>
<%--buildingEngineering.updateFather = function (data) {--%>
<%--var parent = $('#' + buildingEngineering.config().tableId).treegrid('getParent', data.id);--%>
<%--var childrens = parent.children;--%>
<%--var currency = 0;//单方造价--%>
<%--if (buildingEngineering.isNotNull(childrens)) {--%>
...
<%--* @date:2018-08-14--%>
<%--**/--%>
<%--buildingEngineering.totalCalculation = function () {--%>
<%--var currency = 0;//单方造价--%>
<%--$.each($('#' + buildingEngineering.config().tableId).treegrid('getRoots'), function (i, n) {--%>
<%--currency += Number(n.currency);--%>
<%--});--%>
<%--buildingEngineering.updateHtml({--%>
<%--currency: currency--%>
<%--});--%>
<%--};--%>
<%--/**--%>
...
<%--* @date:2018-08-14--%>
<%--**/--%>
<%--buildingEngineering.updateHtml = function (data) {--%>
<%--$('.' + buildingEngineering.config().currencyClass).html(data.currency);--%>
<%--};--%>
...
<%--* @date:2018-08-14--%>
<%--**/--%>
<%--buildingEngineering.getCalculatedResults = function () {--%>
<%--return $('.' + buildingEngineering.config().currencyClass).html();--%>
<%--};--%>
...
<%--* @date:2018-08-13--%>
<%--**/--%>
<%--buildingEngineering.extendOverwrite = function () {--%>
...
<%--buildingEngineering.viewInit = function () {--%>
<%--buildingEngineering.extendOverwrite();--%>
<%--buildingEngineering.init();--%>
<%--/**--%>
<%--* @author:  zch--%>
<%--* 描述:开启单元格编辑--%>
<%--* @date:2018-08-13--%>
<%--**/--%>
<%--$('#' + buildingEngineering.config().tableId).datagrid().datagrid('enableCellEditing');--%>
<%--};--%>
<%--</script>--%>