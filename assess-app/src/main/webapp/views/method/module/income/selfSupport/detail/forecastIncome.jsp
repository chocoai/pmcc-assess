                ...
                <div class="form-inline x-valid">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control input-full"
                                onchange="selfSupportForecast.loadHistoryList(0,$(this).val())">
        ...
        cols.push({
            field: 'id', title: '操作', formatter: function (value, row, index) {
                if (row.amountMoney != null) {
                    ...
                    str += '<a class="btn btn-xs btn-warning tooltips"  data-placement="top" data-original-title="查看明细" onclick="selfSupportForecast.showItemData(' + row.id + ')"><i class="fa fa-search"></i></a>';
                    str += '</div>';
                    return str;
                }
            }
