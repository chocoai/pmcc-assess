...
<div class="x_content">
    <div class="form-horizontal">
        <div class="row form-group ">
            ...
            <div class="col-sm-6">
                <div class="btn-group">
                    <button type="button" class="btn btn-info btn-sm" onclick="selfSupportForecast.loadHistoryList(1,this);">
                        查询
                    </button>
                    ...
                    <button type="button" class="btn btn-warning btn-sm" onclick="selfSupportForecast.delHistoryBatch(1);">
                        删除
                    </button>
                </div>
                ...
                <div class="dropdown" style="display: inline;margin-left: 5px;">
                    ...
                    <div class="dropdown-menu" role="menu" id="ulForecastAnalyseCost">

                    </div>
                </div>
                <div class="btn-group">
                    <button class="btn btn-primary btn-sm" data-toggle="modal"
                            onclick="selfSupportForecast.forecastToHistory(1);">
                        取消预测
                    </button>
                </div>
                <div class="btn-group">
                    <button class="btn btn-primary btn-sm" data-toggle="modal"
                            onclick="selfSupportForecast.startAnalyse(1);">
                        开始分析
                    </button>
                </div>
            </div>
