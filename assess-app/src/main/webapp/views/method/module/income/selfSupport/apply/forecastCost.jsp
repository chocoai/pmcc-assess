...
<div class="x_content">
    <div class="form-horizontal">
        <div class="row form-group ">
            ...
            <div class="col-sm-6">
                <div class="btn-group">
                    <button class="btn btn-primary btn-sm" onclick="selfSupportForecast.loadHistoryList(1,this);">
                        查询
                    </button>
                    ...
                    <button class="btn btn-warning btn-sm" onclick="selfSupportForecast.delHistoryBatch(1);">
                        删除
                    </button>
                </div>
                <div class="btn-group">
