...
<script type="text/javascript">
    ...
    ReportHengFengBank.prototype = {
        ...
        loadDataDicList: function () {
            var cols = [];
            cols.push({field: 'month', title: '月份'});
            cols.push({field: 'consignor', title: '委托人'});
            cols.push({field: 'unitName', title: '报告使用单位'});
            cols.push({field: 'numberValue', title: '报告编号'});
            cols.push({field: 'projectName', title: '项目名称'});
            cols.push({field: 'workDate', title: '工作日期'});
            cols.push({field: 'projectCategoryName', title: '抵押物性质'});
            cols.push({field: 'seat', title: '抵押物地址'});
            cols.push({field: 'area', title: '面积'});
            cols.push({field: 'assessTotal', title: '评估金额'});
            cols.push({field: 'methodNames', title: '评估方法'});
            cols.push({field: 'appraiser', title: '签字估价师'});
            cols.push({field: 'loan', title: '贷款金额'});
            cols.push({field: 'pledgeRatio', title: '抵押率'});
            cols.push({field: 'chargePrice', title: '收费金额'});
            cols.push({field: 'assessCompany', title: '评估公司'});
