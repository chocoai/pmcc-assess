...
<div id="survey_examine_task_list_tb" style="padding:5px;height:auto;display: none;">
    <div style=" margin-bottom:5px">
        <button type="button" onclick="examineTask.keySet()" class="btn btn-warning btn-xs">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                                            ...
                                            <div class="x-valid">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="fast_executeUserName" readonly="readonly"
                                                           ...
                                                           onclick="examineTask.selFastEmployee();">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="examineTask.saveFastset()">
                    保存
                </button>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="examineTask.saveSelectExamineTask()">
                    保存
                </button>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                                            ...
                                            <div class="x-valid">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" readonly="readonly" name="userName"
                                                           placeholder="责任人" class="form-control" required
                                                           onclick="examineTask.editSelectEmployee();">
                                                    <span class="input-group-btn">
                                                    <button type="button" class="btn btn-default docs-tooltip"
                                                            data-toggle="tooltip"
                                                            data-original-title="选择"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="examineTask.saveExamineTask()">
                    保存
                </button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var examineTask = {
        ...
        loadTreeGrid: function () {
            $("#survey_examine_task_list").treegrid({
                ...
                onDblClickRow: function (row) {
                    examineTask.editExamineTask(row);
                },
                ...
                columns: [[
                    ...
                    },
                    {
                        ...
                        var s = "";
                        if (row.pid == 0) {//第一层级
                            s += "<a style='margin-left: 5px;' data-placement='top' data-original-title='新增下级' class='btn btn-xs btn-success tooltips'  onclick='examineTask.addExamineTask(" + row.id + ")'   ><i class='fa fa-plus fa-white'></i></a>";
                        } else {
                            if (!row.bisFinish) {
                                s += "<a style='margin-left: 5px;' data-placement='top' data-original-title='编辑修改' class='btn btn-xs btn-primary tooltips'  onclick='examineTask.editExamineTask(" + row.id + ")'  ><i class='fa fa-edit fa-white'></i></a>";
                                if (!row.bisMust) {
                                    s += "<a style='margin-left: 5px;' data-placement='top' data-original-title='删除' class='btn btn-xs btn-warning tooltips'  onclick='examineTask.delExamineTask(" + row.id + ")'   ><i class='fa fa-minus fa-white'></i></a>";
                                }
                            }
                        }
                        return s;
        ...
        //初始化该调查表下的所有任务
        initExamineTask: function (_this, id) {
            Loading.progressShow();
            $.ajax({
