...
<div class="x_content">
    <div class="x_title">
        <h3>公交信息 <button type="button" class="btn btn-success" onclick="matchingTransit.prototype.showModel()"
                           data-toggle="modal" href="#divBox"> 新增
        </button></h3>
        <div class="clearfix"></div>
    </div>
    <form id="frm_matchingTransit" class="form-horizontal">
