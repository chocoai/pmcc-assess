...
<div class="x_content">
    <div class="x_title">
        <h3>电力通讯网络信息 <button type="button" class="btn btn-success" onclick="houseIntelligent.prototype.showModel()"
...
<div id="divBoxHouseIntelligent" class="modal fade bs-example-modal-lg" data-backdrop="static" tabindex="-1" role="dialog"
     aria-hidden="true">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="switchCircuit" class="form-control search-select select2 switchCircuit">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="lampsLanterns" class="form-control search-select select2 lampsLanterns">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="internalCommunication" class="form-control search-select select2 internalCommunication">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="monitoringSystem" class="form-control search-select select2 monitoringSystem">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="intelligentSystem" class="form-control search-select select2 intelligentSystem">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="wireErection" class="form-control search-select select2 wireErection">
                                            </select>
                                        </div>
                                    </div>
                                </div>
