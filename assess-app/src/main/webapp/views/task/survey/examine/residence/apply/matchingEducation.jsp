...
<div class="x_content">
    ...
    <form id="frm_matchingEducation" class="form-horizontal">
...
<div id="divBoxMatchingEducation" class="modal fade bs-example-modal-lg" data-backdrop="static" tabindex="-1" role="dialog"
     aria-hidden="true">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="schoolLevel" class="form-control search-select select2 schoolLevel">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="schoolGradation" class="form-control search-select select2 schoolGradation">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="schoolNature" class="form-control search-select select2 schoolNature">
                                            </select>
                                        </div>
                                    </div>
                                </div>
