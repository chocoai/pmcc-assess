...
<div class="x_content">
    <div class="x_title">
        <h3>楼栋基础信息 <button type="button" class="btn btn-success" onclick="examineBuilding_.prototype.showModel()"
                           data-toggle="modal" href="#divBox"> 新增
        </button></h3>
        <div class="clearfix"></div>
    </div>
    <form id="frm_examineBuilding_" class="form-horizontal">
...
<div id="divBoxExamineBuilding_" class="modal fade bs-example-modal-lg" data-backdrop="static" tabindex="-1" role="dialog"
     aria-hidden="true">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="楼栋号" name="buildingNumber" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="户型区间" name="unitInterval" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="物业费(数字)" name="propertyFee" data-rule-number='true' class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="公共设施使用费(数字)" name="facilitiesUseFee" data-rule-number='true' class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="楼层起(数字)" name="floorStart" data-rule-number='true' class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="楼层止(数字)" name="floorEnd" data-rule-number='true' class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="总层数(数字)" data-rule-number='true' name="floorCount" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="建筑高度(数字)" data-rule-number='true' name="buildingHeight" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="建筑面积(数字)" data-rule-number='true' name="buildingArea" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="占地面积(数字)" data-rule-number='true' name="coverAnArea" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="层高(数字)" data-rule-number='true' name="floorHeight" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="径深(数字)" data-rule-number='true' name="diameterDepth" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="土地使用年限(数字)" data-rule-number='true' name="landUseYear" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="净高(数字)" data-rule-number='true' name="netHeight" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="所在位置" name="location" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <%--<div class="form-group">--%>
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="propertyType" class="form-control search-select select2 propertyType">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="buildingStructurePid" class="form-control search-select select2 buildingStructure">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" id="frmExamineBuilding_buildingStructure" name="buildingStructure" class="form-control search-select select2 buildingStructureV">
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="buildingCategory" class="form-control search-select select2 buildingCategory">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="builderId" class="form-control search-select select2 builderId">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="propertyId" class="form-control search-select select2 propertyId">
                                            </select>
                                        </div>
                                    </div>
                                </div>
