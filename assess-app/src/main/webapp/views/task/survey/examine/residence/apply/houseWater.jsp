...
<div class="x_content">
    <div class="x_title">
        <h3>供排水情况信息 <button type="button" class="btn btn-success" onclick="houseWater.prototype.showModel()"
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="取水设备" name="waterIntakeEquipment" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="采水点数" name="intakePointNumber" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="自然区间取水点数" name="natrueIntakePointNumber" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="drainageCircuit" class="form-control search-select select2 drainageCircuit">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="purificationEquipmentPrice" class="form-control search-select select2 purificationEquipmentPrice">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="waterIntakeEquipmentPrice" class="form-control search-select select2 waterIntakeEquipmentPrice">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="supplyErectionMethod" class="form-control search-select select2 supplyErectionMethod">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="x-valid">
                                        ...
                                        <div class="col-sm-10">
                                            <select required="required" name="pretreatedWater" class="form-control search-select select2 pretreatedWater">
                                            </select>
                                        </div>
                                    </div>
                                </div>
