...
<div class="x_content">
    <div class="x_title">
        <h3>空调情况信息 <button type="button" class="btn btn-success" onclick="houseAirConditioner.prototype.showModel()"
...
<div id="divBoxHouseAirConditioner" class="modal fade bs-example-modal-lg" data-backdrop="static" tabindex="-1" role="dialog"
     aria-hidden="true">
