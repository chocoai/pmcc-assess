...
(function ($) {
    ...
    $.fn.linkbutton.parseOptions = function (_9f) {
        var t = $(_9f);
        return $.extend({}, $.parser.parseOptions(_9f, ["id", "iconCls", "iconAlign", "group", "size", {
            plain: "boolean",
            toggle: "boolean",
            selected: "boolean"
        }]), {
...
(function ($) {
    ...
    $.fn.tree.parseOptions = function (_1b4) {
        var t = $(_1b4);
        return $.extend({}, $.parser.parseOptions(_1b4, ["url", "method", {
            checkbox: "boolean",
    ...
    $.fn.tree.defaults = {
        ...
        loader: function (_1c0, _1c1, _1c2) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _1c0, dataType: "json", success: function (data) {
                    _1c1(data);
                }, error: function () {
        ...
        view: _1b9,
        onBeforeLoad: function (node, _1c4) {
        },
...
(function ($) {
    ...
    $.fn.progressbar = function (_1d8, _1d9) {
        ...
        return this.each(function () {
            ...
            if (_1db) {
                ...
                _1db = $.data(this, "progressbar", {
                    options: $.extend({}, $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this), _1d8),
                    bar: init(this)
                });
            }
    ...
    $.fn.progressbar.defaults = {
        width: "auto", height: 22, value: 0, text: "{value}%", onChange: function (_1e0, _1e1) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.tooltip.parseOptions = function (_200) {
        var t = $(_200);
        var opts = $.extend({}, $.parser.parseOptions(_200, ["position", "showEvent", "hideEvent", "content", {
            trackMouse: "boolean",
            deltaX: "number",
            deltaY: "number",
            showDelay: "number",
...
(function ($) {
    ...
    function _203(_204, _205) {
        ...
        if (_205) {
            $.extend(opts, {
                width: _205.width,
                height: _205.height,
                minWidth: _205.minWidth,
                maxWidth: _205.maxWidth,
                minHeight: _205.minHeight,
                maxHeight: _205.maxHeight,
                left: _205.left,
                top: _205.top
            });
        }
    ...
    $.fn.panel.parseOptions = function (_25b) {
        var t = $(_25b);
        return $.extend({}, $.parser.parseOptions(_25b, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", "method", {
            cache: "boolean",
            fit: "boolean",
            border: "boolean",
            noheader: "boolean"
    ...
    $.fn.panel.defaults = {
        ...
        loader: function (_25c, _25d, _25e) {
...
(function ($) {
    ...
    function _272(_273) {
        ...
        var win = $(_273).panel($.extend({}, _274.options, {
            border: false,
            doSize: true,
            closed: true,
            cls: "window",
            ...
            onOpen: function () {
                ...
                if (_274.shadow) {
                    _274.shadow.css({
                        ...
                        left: opts.left,
                        top: opts.top,
                        width: _274.window._outerWidth(),
                        height: _274.window._outerHeight()
                    });
                }
        ...
        if (opts.modal == true) {
            ...
            _274.mask.css({
                width: (opts.inline ? _274.mask.parent().width() : _278().width),
                height: (opts.inline ? _274.mask.parent().height() : _278().height),
                display: "none"
            });
        }
        if (_274.shadow) {
    ...
    function _279(_27a) {
        ...
        _27b.window.draggable({
            handle: ">div.panel-header>div.panel-title",
            disabled: _27b.options.draggable == false,
            onStartDrag: function (e) {
                if (_27b.mask) {
        ...
        _27b.window.resizable({
            disabled: _27b.options.resizable == false, onStartResize: function (e) {
                if (_27b.pmask) {
                    _27b.pmask.remove();
                }
                ...
                _27b.pmask.css({
                    ...
                    left: e.data.left,
                    top: e.data.top,
                    width: _27b.window._outerWidth(),
                    height: _27b.window._outerHeight()
                });
                if (_27b.proxy) {
                    _27b.proxy.remove();
                }
    ...
    $.fn.window.methods = {
        options: function (jq) {
            ...
            return $.extend(_281, {
                closed: _280.closed,
                collapsed: _280.collapsed,
                minimized: _280.minimized,
                maximized: _280.maximized
            });
        }, window: function (jq) {
    ...
    $.fn.window.parseOptions = function (_283) {
        return $.extend({}, $.fn.panel.parseOptions(_283), $.parser.parseOptions(_283, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
    ...
    $.fn.dialog.methods = {
        options: function (jq) {
            ...
            $.extend(_292, {
                ...
                top: _293.top,
                closed: _293.closed,
                collapsed: _293.collapsed,
                minimized: _293.minimized,
                maximized: _293.maximized
            });
            return _292;
        }, dialog: function (jq) {
...
(function ($) {
    ...
    $.fn.accordion = function (_2ef, _2f0) {
        ...
        return this.each(function () {
            ...
            if (_2f1) {
                ...
                $.data(this, "accordion", {
                    options: $.extend({}, $.fn.accordion.defaults, $.fn.accordion.parseOptions(this), _2ef),
    ...
    $.fn.accordion.parseOptions = function (_2f9) {
        var t = $(_2f9);
        return $.extend({}, $.parser.parseOptions(_2f9, ["width", "height", {
            fit: "boolean",
            border: "boolean",
            animate: "boolean",
            multiple: "boolean",
...
(function ($) {
    function _304(_305) {
        ...
        if (_30a > _30b) {
            ...
            if (opts.toolPosition == "left") {
                ...
                wrap.css({
                    marginLeft: _307.outerWidth() + tool._outerWidth(),
                    marginRight: _308._outerWidth(),
                    width: _30b - _307.outerWidth() - _308.outerWidth()
                });
            } else {
                tool.css({left: "", right: _308.outerWidth()});
                wrap.css({
                    marginLeft: _307.outerWidth(),
                    marginRight: _308.outerWidth() + tool._outerWidth(),
                    width: _30b - _307.outerWidth() - _308.outerWidth()
                });
            }
        } else {
    ...
    function _32d(_32e, _32f, pp) {
        ...
        pp.panel($.extend({}, _32f, {
            tab: tab,
            border: false,
            noheader: true,
            closed: true,
            doSize: false,
            iconCls: (_32f.icon ? _32f.icon : undefined),
            onLoad: function () {
                if (_32f.onLoad) {
    ...
    $.fn.tabs = function (_363, _364) {
        ...
        return this.each(function () {
            ...
            if (_365) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _363),
                    tabs: [],
                    selectHis: []
                });
                _31e(this);
    ...
    $.fn.tabs.parseOptions = function (_372) {
        return $.extend({}, $.parser.parseOptions(_372, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean",
            headerWidth: "number",
...
(function ($) {
    ...
    function _390(_391, _392, el) {
        ...
        var _394 = $.extend({}, $.fn.layout.paneldefaults, {
        ...
        _398.resizable($.extend({}, {
            handles: (_397[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                _382 = true;
    ...
    function _3a2(_3a3, _3a4, _3a5) {
        ...
        function _3ab() {
            ...
            if (_3a4 == "east") {
                ...
                return {
                    resizeC: {width: _3b0},
                    expand: {left: cc.width() - _3af},
                    expandP: {top: _3ad.top, left: cc.width() - _3ae, width: _3ae, height: _3ad.height},
                    collapse: {left: cc.width(), top: _3ad.top, height: _3ad.height}
                };
            } else {
                if (_3a4 == "west") {
                    var _3af = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: {width: _3b0, left: _3ae - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3ad.top, width: _3ae, height: _3ad.height},
                        collapse: {left: -_3af, top: _3ad.top, height: _3ad.height}
                    };
                } else {
                    if (_3a4 == "north") {
                        ...
                        _3a6.east.add(_3a6.west).add(_3a6.expandEast).add(_3a6.expandWest).panel("resize", {
                            top: _3ae - 1,
                            height: hh
                        });
                        return {
                            resizeC: {top: _3ae - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3ae},
                            collapse: {top: -_3b1, width: cc.width()}
                        };
                    } else {
                        if (_3a4 == "south") {
                            var _3b1 = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3b1},
                                expandP: {top: cc.height() - _3ae, left: 0, width: cc.width(), height: _3ae},
    ...
    function _3b2(_3b3, _3b4) {
        ...
        function _3b9() {
            ...
            if (_3b4 == "east" && _3b5.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _3ba.top, height: _3ba.height},
                    expand: {left: cc.width() - p.panel("panel")._outerWidth()}
                };
            } else {
                if (_3b4 == "west" && _3b5.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _3ba.top, height: _3ba.height},
                        expand: {left: 0}
                    };
                } else {
    ...
    $.fn.layout.parsePanelOptions = function (_3d1) {
        var t = $(_3d1);
        return $.extend({}, $.fn.panel.parseOptions(_3d1), $.parser.parseOptions(_3d1, ["region", {
            split: "boolean",
...
(function ($) {
    ...
    $.fn.menu.parseOptions = function (_414) {
        return $.extend({}, $.parser.parseOptions(_414, [{
            minWidth: "number",
            duration: "number",
...
(function ($) {
    ...
    $.fn.menubutton.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "menubutton").options, {
                toggle: _426.toggle,
                selected: _426.selected,
                disabled: _426.disabled
            });
        }, destroy: function (jq) {
            return jq.each(function () {
    ...
    $.fn.menubutton.parseOptions = function (_427) {
        var t = $(_427);
        return $.extend({}, $.fn.linkbutton.parseOptions(_427), $.parser.parseOptions(_427, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
    ...
    $.fn.splitbutton.parseOptions = function (_42f) {
        var t = $(_42f);
        return $.extend({}, $.fn.linkbutton.parseOptions(_42f), $.parser.parseOptions(_42f, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
    ...
    function _441(_445) {
        ...
        $(_445).tooltip($.extend({}, opts.tipOptions, {
            content: _446.message,
    ...
    $.fn.validatebox.parseOptions = function (_460) {
        var t = $(_460);
        return $.extend({}, $.parser.parseOptions(_460, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            deltaX: "number"
        }]), {
    ...
    $.fn.validatebox.defaults = {
        ...
        novalidate: false,
        events: {
            focus: _437, blur: _43b, mouseenter: _43f, mouseleave: _442, click: function (e) {
                var t = $(e.data.target);
                if (!t.is(":focus")) {
                    t.trigger("focus");
                }
...
(function ($) {
    ...
    function _471(_472, _473) {
        ...
        _476.css({
            paddingLeft: (_472.style.paddingLeft || ""),
            paddingRight: (_472.style.paddingRight || ""),
            marginLeft: _479("left"),
            marginRight: _479("right")
        });
        if (opts.multiline) {
    ...
    function _47c(_47d) {
        ...
        _47e.validatebox($.extend({}, opts, {
            deltaX: $(_47d).textbox("getTipX"), onBeforeValidate: function () {
                var box = $(this);
                if (!box.is(":focus")) {
    ...
    $.fn.textbox = function (_48f, _490) {
        ...
        return this.each(function () {
            ...
            if (_493) {
                ...
                _493 = $.data(this, "textbox", {
                    options: $.extend({}, $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _48f),
                    textbox: init(this)
                });
    ...
    $.fn.textbox.parseOptions = function (_4a2) {
        var t = $(_4a2);
        return $.extend({}, $.fn.validatebox.parseOptions(_4a2), $.parser.parseOptions(_4a2, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", {
            multiline: "boolean",
            editable: "boolean",
            iconWidth: "number"
        }]), {
...
(function ($) {
    function _4b1(_4b2) {
        ...
        function _4b8(item) {
            ...
            $(_4b2).textbox("button").menubutton({
                text: item.text,
...
(function ($) {
    ...
    function load(_4ce, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _4cf, dataType: "json", success: function (data) {
                    _4d0(data);
                }, error: function () {
    ...
    $.fn.form.defaults = {
        novalidate: false, ajax: true, url: null, queryParams: {}, onSubmit: function (_4f0) {
...
(function ($) {
    ...
    $.fn.numberbox.parseOptions = function (_500) {
        var t = $(_500);
        return $.extend({}, $.fn.textbox.parseOptions(_500), $.parser.parseOptions(_500, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
...
(function ($) {
    ...
    $.fn.timespinner.parseOptions = function (_56a) {
        return $.extend({}, $.fn.spinner.parseOptions(_56a), $.parser.parseOptions(_56a, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
...
(function ($) {
    ...
    function _590(_591) {
        ...
        _595.add(_596).children("div.datagrid-body").css({
            marginTop: _59c,
            height: (isNaN(parseInt(opts.height)) ? "" : (_594 - _59d)),
            minHeight: (_59f ? _59f - _59e - _59d : ""),
            maxHeight: (_5a0 ? _5a0 - _59e - _59d : "")
        });
    ...
    function _5b5(_5b6, _5b7) {
        ...
        return {
            ...
            dc: {
                ...
                view1: _5bc,
                view2: _5bd,
                header1: _5bc.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2: _5bd.children("div.datagrid-header").children("div.datagrid-header-inner"),
                body1: _5bc.children("div.datagrid-body").children("div.datagrid-body-inner"),
                body2: _5bd.children("div.datagrid-body"),
                footer1: _5bc.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
                footer2: _5bd.children("div.datagrid-footer").children("div.datagrid-footer-inner")
            }
        };
    };
    ...
    function _5be(_5bf) {
        ...
        _5c1.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_5c2, _5c3) {
        ...
        if (opts.pagination) {
            ...
            _5c6.pagination({
                ...
                onSelectPage: function (_5c7, _5c8) {
            ...
            if (col && col.editor) {
                ...
                if (_6a2) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _6a2,
                        target: _6a2.init(cell.find("td"), _6a1),
                        field: _69f,
                        type: _6a0,
                        oldHtml: _6a3
                    });
    ...
    var _6ec = $.extend({}, _6de(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_6ed, _6ee) {
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            var opts = $.extend(_705, {
                width: _706.width,
                height: _706.height,
                closed: _706.closed,
                collapsed: _706.collapsed,
                minimized: _706.minimized,
                maximized: _706.maximized
            });
            return opts;
    ...
    $.fn.datagrid.parseOptions = function (_732) {
        var t = $(_732);
        return $.extend({}, $.fn.panel.parseOptions(_732), $.parser.parseOptions(_732, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _735 = {
        render: function (_736, _737, _738) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        showFooter: false,
        scrollbarSize: 18,
        rowEvents: {mouseover: _5df(true), mouseout: _5df(false), click: _5e7, dblclick: _5f1, contextmenu: _5f5},
        rowStyler: function (_777, _778) {
        },
        loader: function (_779, _77a, _77b) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _779, dataType: "json", success: function (data) {
                    _77a(data);
                }, error: function () {
        ...
        editors: _6ec,
        finder: {
            getTr: function (_77c, _77d, type, _77e) {
                type = type || "body";
                _77e = _77e || 0;
...
(function ($) {
    ...
    function _7b3(_7b4) {
        ...
        $(_7b4).datagrid($.extend({}, opts, {
            cls: "propertygrid",
            view: (opts.showGroup ? opts.groupView : opts.view),
            onBeforeEdit: function (_7b6, row) {
    ...
    var _7c2 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_7c3, _7c4, _7c5) {
            var _7c6 = [];
    ...
    $.extend(_7c2, {
        refreshGroupTitle: function (_7e9, _7ea) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        groupView: _7c2,
        groupField: "group",
        groupFormatter: function (_7ff, rows) {
            return _7ff;
        }
    });
})(jQuery);
(function ($) {
    function _800(_801) {
        ...
        if (opts.pagination) {
            ...
            _81b.pagination({
                ...
                pageSize: opts.pageSize,
                pageList: opts.pageList,
                onSelectPage: function (_81c, _81d) {
    ...
    $.fn.treegrid = function (_88b, _88c) {
        ...
        return this.each(function () {
            ...
            if (_88e) {
                ...
                _88e = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _88b),
                    data: []
                });
            }
            _800(this);
    ...
    var _898 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_899, _89a, _89b) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        loader: function (_8d5, _8d6, _8d7) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _8d5, dataType: "json", success: function (data) {
                    _8d6(data);
                }, error: function () {
        ...
        finder: {
            getTr: function (_8d9, id, type, _8da) {
                type = type || "body";
                _8da = _8da || 0;
...
(function ($) {
    ...
    function _8e2(_8e3) {
        ...
        $(_8e3).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _8e9, onChange: function () {
            }
        }));
    ...
    function _8f9(_8fa) {
        ...
        if (_8fe.closed) {
            _8fd.panel("panel").show().css({
                zIndex: ($.fn.menu ? $.fn.menu.defaults.zIndex++ : $.fn.window.defaults.zIndex++),
                left: -999999
            });
            _8fd.panel("resize", {
                width: (opts.panelWidth ? opts.panelWidth : _8fc._outerWidth()),
    ...
    $.fn.combo = function (_920, _921) {
        ...
        return this.each(function () {
            ...
            if (_923) {
                ...
                _923 = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _920),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function (_926) {
        var t = $(_926);
        return $.extend({}, $.fn.textbox.parseOptions(_926), $.parser.parseOptions(_926, ["separator", "panelAlign", {
            panelWidth: "number",
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _8f2, keydown: _8f6, paste: _8f6, drop: _8f6},
        panelWidth: null,
        panelHeight: 200,
        panelMinWidth: null,
        panelMaxWidth: null,
...
(function ($) {
    ...
    $.fn.combobox = function (_95d, _95e) {
        ...
        return this.each(function () {
            ...
            if (_960) {
                ...
                _960 = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _95d),
                    data: []
                });
                _959(this);
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                width: _961.width,
                height: _961.height,
                originalValue: _961.originalValue,
                disabled: _961.disabled,
                readonly: _961.readonly
            });
        }, getData: function (jq) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_96c) {
            return _96c;
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _96d, dataType: "json", success: function (data) {
                    _96e(data);
                }, error: function () {
    ...
    $.fn.combotree.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotree").options, {
                width: _98f.width,
                height: _98f.height,
                originalValue: _98f.originalValue,
                disabled: _98f.disabled,
                readonly: _98f.readonly
            });
...
(function ($) {
    function _994(_995) {
        ...
        var grid = _996.grid;
        $(_995).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                ...
                $(this).combogrid("grid").datagrid("resize", {
                    ...
                    minHeight: (_998 ? _998 - _997 : ""),
                    maxHeight: (_999 ? _999 - _997 : "")
                });
    ...
    $.fn.combogrid.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combogrid").options, {
                width: _9ba.width,
                height: _9ba.height,
                originalValue: _9ba.originalValue,
                disabled: _9ba.disabled,
                readonly: _9ba.readonly
            });
        }, grid: function (jq) {
...
(function ($) {
    function _9be(_9bf) {
        ...
        $(_9bf).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _9c1(this);
                _9c2(this);
                _9c3(this);
        ...
        if (!_9c0.calendar) {
            ...
            $.extend(_9c0.calendar.calendar("options"), {
    ...
    $.fn.datebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datebox").options, {
                width: _9df.width,
                height: _9df.height,
                originalValue: _9df.originalValue,
                disabled: _9df.disabled,
                readonly: _9df.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        panelWidth: 180, panelHeight: "auto", sharedCalendar: null, keyHandler: {
            ...
            text: function (_9e4) {
                ...
                $(_9e5).datebox("calendar").calendar({
                    year: new Date().getFullYear(),
                    month: new Date().getMonth() + 1,
                    current: new Date()
                });
...
(function ($) {
    function _9e8(_9e9) {
        ...
        $(_9e9).datebox("calendar").calendar({
            onSelect: function (date) {
    ...
    $.fn.datetimebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue: _9fe.originalValue,
                disabled: _9fe.disabled,
                readonly: _9fe.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
...
(function ($) {
    ...
    function _a1f(_a20) {
        ...
        _a22.find("a.slider-handle").draggable({
    ...
    $.fn.slider = function (_a3b, _a3c) {
        ...
        return this.each(function () {
            ...
            if (_a3d) {
                ...
                _a3d = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _a3b),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_a40) {
        var t = $(_a40);
        return $.extend({}, $.parser.parseOptions(_a40, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            min: "number",
            max: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_a41) {
            return _a41;
        },
        converter: {
            toPosition: function (_a42, size) {
                var opts = $(this).slider("options");
