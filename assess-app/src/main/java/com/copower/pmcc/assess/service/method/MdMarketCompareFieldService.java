        ...
        for (DataSetUseField dataSetUseField : setUseFieldList) {
            switch (dataSetUseField.getFieldName()) {
                ...
                case AssessMarketCompareConstant.BUILDING_AREA://建筑面积（㎡）
                    list.add(getMarketCompareItemDto(AssessMarketCompareConstant.BUILDING_AREA, String.valueOf(examineEstate.getFloorArea())));
                    break;
                case AssessMarketCompareConstant.FLOOR_COUNT://层数
                    list.add(getMarketCompareItemDto(AssessMarketCompareConstant.FLOOR_COUNT, String.valueOf(examineBuilding.getFloorCount())));
                    break;
                ...
                case AssessMarketCompareConstant.GAS_SUPPLY_MODE://供气方式
                    if (CollectionUtils.isNotEmpty(estateSupplyList)) {
                        ...
                        list.add(getMarketCompareItemDto(AssessMarketCompareConstant.GAS_SUPPLY_MODE, stringBuilder.toString()));
                    }
                    break;
