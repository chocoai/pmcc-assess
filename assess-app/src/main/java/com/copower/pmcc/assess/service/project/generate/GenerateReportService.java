...
public class GenerateReportService {
    ...
    private String fullReportPath(BaseReportTemplate baseReportTemplate, GenerateReportGeneration generateReportGeneration, String reportType) throws Exception {
        ...
        if (CollectionUtils.isNotEmpty(sysAttachmentDtoList)) {
            tempDir = generateCompareFile(baseReportTemplate, baseAttachmentService.downloadFtpFileToLocal(sysAttachmentDtoList.get(0).getId()), generateReportGeneration, reportType);
        }
        return tempDir;
    }
     ...
     * @throws Exception
     */
    public String generateCompareFile(BaseReportTemplate baseReportTemplate, String localPath, GenerateReportGeneration generateReportGeneration, String reportType) throws Exception {
