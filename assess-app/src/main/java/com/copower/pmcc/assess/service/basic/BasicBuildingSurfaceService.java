...
import com.copower.pmcc.assess.dal.basis.dao.basic.BasicBuildingSurfaceDao;
        ...
        if (basicBuildingSurface.getId() == null || basicBuildingSurface.getId().intValue() == 0) {
            ...
            if(updateNull){
                ...
                if(buildingSurface!=null){
                    basicBuildingSurface.setBisDelete(buildingSurface.getBisDelete());
                    ...
                    basicBuildingSurface.setGmtModified(DateUtils.now());
                }
            }
