...
import com.copower.pmcc.assess.common.enums.BasicHouseTradingLeaseAndSellDtoTypeEnum;
...
public class BasicHouseTradingLeaseAndSellDtoService {
    ...
    public void saveBasicHouseTradingLeaseAndSellDto(BasicHouseTradingLeaseAndSellDto basicHouseTradingLeaseAndSellDto) throws Exception{
        ...
        if (StringUtils.isNotEmpty(tradingType)) {
            if (Objects.equal(tradingType, BasicHouseTradingLeaseAndSellDtoTypeEnum.BasicHouseTradingLease.getKey())) {
            ...
            if (Objects.equal(tradingType, BasicHouseTradingLeaseAndSellDtoTypeEnum.BasicHouseTradingSell.getKey())) {
    ...
    public BootstrapTableVo getVoList(String type,BasicHouseTradingLease basicHouseTradingLease,BasicHouseTradingSell basicHouseTradingSell)throws Exception{
        ...
        if (Objects.equal(type,BasicHouseTradingLeaseAndSellDtoTypeEnum.BasicHouseTradingLease.getKey())){
            vo = basicHouseTradingLeaseService.getBootstrapTableVo(basicHouseTradingLease,type);
        }
        if (Objects.equal(type,BasicHouseTradingLeaseAndSellDtoTypeEnum.BasicHouseTradingSell.getKey())){
