...
public interface CustomReportJianSheBankMapper {
    //查询任务
    List<CustomReportJianSheBank> getCustomReportJianSheBankList(@Param("numberValue") String numberValue, @Param("unitName") String unitName, @Param("reportType") Integer reportType,
