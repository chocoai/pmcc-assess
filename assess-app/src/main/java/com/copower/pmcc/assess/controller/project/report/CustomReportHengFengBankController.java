...
public class CustomReportHengFengBankController {
    ...
    public BootstrapTableVo getCustomReportHengFengBankList(Integer reportType, String numberValue, String unitName,
        ...
        try {
            vo = customReportHengFengBankService.getCustomReportHengFengBankList(numberValue, unitName, reportType,queryStartDate,queryEndDate);
        } catch (Exception e1) {
    ...
    public void export(HttpServletResponse response, String numberValue, String unitName, Integer reportType,String queryStartDate,
        ...
        try {
            customReportHengFengBankService.export(response, numberValue, unitName, reportType,queryStartDate,queryEndDate);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
