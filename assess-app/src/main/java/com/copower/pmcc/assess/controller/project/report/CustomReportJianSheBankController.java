...
public class CustomReportJianSheBankController {
    ...
    public BootstrapTableVo getCustomReportJianSheBankList(String numberValue, String unitName, Integer reportType) {
        ...
        try {
            vo = customReportJianSheBankService.getCustomReportJianSheBankList(numberValue, unitName, reportType);
        } catch (Exception e1) {
    ...
    public void export(HttpServletResponse response, String numberValue, String unitName, Integer reportType) throws Exception {
        try {
            customReportJianSheBankService.export(response, numberValue, unitName, reportType);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
