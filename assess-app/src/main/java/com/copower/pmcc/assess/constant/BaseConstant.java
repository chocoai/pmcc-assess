...
public class BaseConstant {
    ...
    public static final String[] ASSESS_IGNORE_ARRAY = new String[]{"id","processInsId","bisCase","applyId","quoteId", "creator", "gmtCreated", "gmtModified"};//对象拷贝忽略的默认字段
    public static final List<String> ASSESS_IGNORE_LIST= Lists.newArrayList("id","creator", "gmtCreated", "gmtModified");
