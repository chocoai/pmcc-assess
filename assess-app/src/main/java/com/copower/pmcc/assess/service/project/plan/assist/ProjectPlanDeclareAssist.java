...
public class ProjectPlanDeclareAssist implements ProjectPlanInterface {
    ...
    public ModelAndView applyView(ProjectPlan projectPlan) {
        ModelAndView modelAndView = serviceComponent.baseFormModelAndView("/plan/planDeclareIndex", "", 0, "-1", "");
        return modelAndView;
    }

    @Override
    public ModelAndView approvalView(ProjectPlan projectPlan, String taskId, Integer boxId, String agentUserAccount) {
        ModelAndView modelAndView = serviceComponent.baseFormModelAndView("/plan/planDeclareApproval", projectPlan.getProcessInsId(), boxId, taskId, agentUserAccount);
        return modelAndView;
    }

    @Override
    public ModelAndView approvalEdit(ProjectPlan projectPlan, String taskId, Integer boxId, String agentUserAccount) {
        ModelAndView modelAndView = serviceComponent.baseFormModelAndView("/plan/planDeclareIndex", projectPlan.getProcessInsId(), boxId, taskId, agentUserAccount);
        return modelAndView;
    }

    @Override
    public ModelAndView detailsView(ProjectPlan projectPlan, Integer boxId) {
        ModelAndView modelAndView = serviceComponent.baseFormModelAndView("/plan/planDeclareApproval", projectPlan.getProcessInsId(), boxId, "-1", "");
        return modelAndView;
    }
}
