 ...
 * @time: 13:45
 */
public class AssessExamineTaskConstant {
    /*
     * 基础数据
     */
    ...
    public static final String EXAMINE_UNIT_HUXING_TYPE = "unit.huxing.type";//户型
    public static final String EXAMINE_UNIT_HUXING_TYPE_PRODUCTION = "unit.huxing.type.production";//生产用房
    public static final String EXAMINE_UNIT_HUXING_TYPE_OFFICE = "unit.huxing.type.office";//行政办公用房
