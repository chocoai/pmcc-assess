...
public class ExamineHouseRoomController {
    ...
    @ResponseBody
    @RequestMapping(value = "/getExamineHouseRoomById",method = {RequestMethod.GET},name = "获取房间")
    ...
    @ResponseBody
    @RequestMapping(value = "/getExamineHouseRoomList",method = {RequestMethod.GET},name = "获取房间列表")
    ...
    @ResponseBody
    @RequestMapping(value = "/deleteExamineHouseRoomById",method = {RequestMethod.POST},name = "删除房间")
    ...
    @ResponseBody
    @RequestMapping(value = "/saveAndUpdateExamineHouseRoom",method = {RequestMethod.POST},name = "更新房间")
    ...
    @ResponseBody
    @RequestMapping(value = "/examine_unit_house_type",method = {RequestMethod.GET},name = "房间类别")
