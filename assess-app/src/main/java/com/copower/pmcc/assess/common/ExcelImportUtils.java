...
public final class ExcelImportUtils implements Serializable {
     ...
     * @return
     */
    public static boolean excelImportHelp(Multimap<String, Map.Entry<Class<?>, Integer>> classArrayListMultimap, Object target, StringBuilder stringBuilder, Row row, Multimap<String, List<BaseDataDic>> baseMap, List<String> requiredList, boolean isBreak) {
                    ...
                    if (CollectionUtils.isNotEmpty(listCollection)) {
                        ...
                        while (listIterator.hasNext()) {
                            ...
                            if (CollectionUtils.isNotEmpty(baseDataDicList)) {
                                BaseDataDic typeDic = getDataDicByName(baseDataDicList, value);
                                if (typeDic != null) {
     ...
     * @return
     */
    public static BaseDataDic getDataDicByName(List<BaseDataDic> list, String name) {
        if (CollectionUtils.isEmpty(list)) return null;
        if (org.apache.commons.lang3.StringUtils.isBlank(name)) return null;
        for (BaseDataDic baseDataDic : list) {
            if (org.apache.commons.lang3.StringUtils.equals(baseDataDic.getName().trim(), name.trim()))
                return baseDataDic;
        }
        return null;
    }
