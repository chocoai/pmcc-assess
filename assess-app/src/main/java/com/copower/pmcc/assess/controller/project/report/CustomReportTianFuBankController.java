...
public class CustomReportTianFuBankController {
    ...
    public BootstrapTableVo getCustomReportTianFuBankList(String numberValue, String unitName,Integer reportType,
        ...
        try {
            vo = customReportTianFuBankService.getCustomReportTianFuBankList(numberValue, unitName,reportType,queryStartDate,queryEndDate);
        } catch (Exception e1) {
    ...
    public void export(HttpServletResponse response, String numberValue, String unitName,Integer reportType,
        ...
        try {
            customReportTianFuBankService.export(response, numberValue, unitName,reportType,queryStartDate,queryEndDate);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
