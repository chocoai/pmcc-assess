...
public class CustomReportTianJinBankController {
    ...
    public BootstrapTableVo getCustomReportTianJinBankList(String numberValue, String unitName, Integer reportType,
        ...
        try {
            vo = customReportTianJinBankService.getCustomReportTianJinBankList(numberValue, unitName, reportType,queryStartDate,queryEndDate);
        } catch (Exception e1) {
    ...
    public void export(HttpServletResponse response, String numberValue, String unitName,Integer reportType,
        ...
        try {
            customReportTianJinBankService.export(response, numberValue, unitName, reportType,queryStartDate,queryEndDate);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
