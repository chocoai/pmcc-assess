...
//public class ProjectPauseController extends BaseController {
//    @Autowired
...
//
//    @RequestMapping(value = "/apply", name = "项目暂停申请")
//    public ModelAndView apply(Integer projectId) throws BusinessException {
//        //获取流程模型
//        String boxName = baseParameterService.getBaseParameter(CostsParameterEnum.PROJECT_PAUSE_CHANGE_PROCESS_KEY);
...
//        try {
//            stateChangeService.applyCommit(costsProjectChangeLog,CostsParameterEnum.PROJECT_PAUSE_CHANGE_PROCESS_KEY,ProjectChangeTypeEnum.PAUSE_CHANGE);
