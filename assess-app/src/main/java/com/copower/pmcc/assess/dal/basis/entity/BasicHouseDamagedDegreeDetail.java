...
public class BasicHouseDamagedDegreeDetail {
    private Integer id;

    private Integer houseId;

    private Integer damagedDegreeId;
    ...
    public Integer getDamagedDegreeId() {
        return damagedDegreeId;
    }

    public void setDamagedDegreeId(Integer damagedDegreeId) {
        this.damagedDegreeId = damagedDegreeId;
    }
