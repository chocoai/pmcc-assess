...
//        //获取流程模型
//        String boxName = baseParameterService.getBaseParameter(CostsParameterEnum.PROJECT_STOP_CHANGE_PROCESS_KEY);
...
//        try {
//            stateChangeService.applyCommit(costsProjectChangeLog,CostsParameterEnum.PROJECT_STOP_CHANGE_PROCESS_KEY,ProjectChangeTypeEnum.STOP_CHANGE);
