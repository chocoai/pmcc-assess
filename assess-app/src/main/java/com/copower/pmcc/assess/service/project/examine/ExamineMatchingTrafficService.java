 ...
 */
@Service
public class ExamineMatchingTrafficService {
    ...
    public BootstrapTableVo getExamineMatchingTrafficList(ExamineMatchingTraffic examineMatchingTraffic){
        ...
        List<ExamineMatchingTraffic> vos = getMatchingTrafficList(examineMatchingTraffic);
        vo.setTotal(page.getTotal());
        vo.setRows(org.apache.commons.collections.CollectionUtils.isEmpty(vos) ? new ArrayList<ExamineMatchingTraffic>() : vos);
        return vo;
    }
