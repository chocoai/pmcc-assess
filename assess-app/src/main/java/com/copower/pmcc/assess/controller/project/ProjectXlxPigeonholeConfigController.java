...
import com.copower.pmcc.assess.service.project.ProjectXlxPigeonholeConfigService;
...
public class ProjectXlxPigeonholeConfigController {
    ...
    public ModelAndView index() {
        ModelAndView modelAndView = processControllerComponent.baseModelAndView("/project/projectXlxPigeonholeConfigView");
        //获取到类型 类别 范围
