...
public interface CustomReportGongShangBankMapper {
    //查询任务
    List<CustomReportGongShangBank> getCustomReportGongShangBankList(@Param("numberValue") String numberValue, @Param("unitName") String unitName, @Param("reportType") Integer reportType,@Param("consultationId") Integer consultationId,
