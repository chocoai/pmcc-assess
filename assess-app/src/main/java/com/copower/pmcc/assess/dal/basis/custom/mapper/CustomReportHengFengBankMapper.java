...
public interface CustomReportHengFengBankMapper {
    //查询任务
    List<CustomReportHengFengBank> getCustomReportHengFengBankList(@Param("numberValue") String numberValue, @Param("unitName") String unitName, @Param("reportType") Integer reportType, @Param("consultationId") Integer consultationId,
