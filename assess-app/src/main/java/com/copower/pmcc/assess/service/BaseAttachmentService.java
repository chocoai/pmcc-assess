...
public class BaseAttachmentService {
    @Autowired
    private BaseAttachmentDao cmsBaseAttachmentDao;
    @Autowired
    ...
    public Integer uploadFileToServer(AttachmentDto attachmentDto, MultipartFile multipartFile) throws BusinessException {
        ...
        Integer integer = cmsBaseAttachmentDao.addAttachment(sysAttachment);
        return integer;
    }
    ...
    public List<AttachmentVo> getFilesFromServer(String ids) throws Exception {
        ...
        List<BaseAttachment> attachments = cmsBaseAttachmentDao.getAttachmentById(FormatUtils.ListStringToListInteger(FormatUtils.transformString2List(ids)));
    ...
    public List<AttachmentVo> getAttachmentVos(BaseAttachment sysAttachment) {
        List<BaseAttachment> attachmentList = cmsBaseAttachmentDao.getAttachmentList(sysAttachment);
    ...
    public List<BaseAttachment> getAttachmentList(BaseAttachment sysAttachment) {
        return cmsBaseAttachmentDao.getAttachmentList(sysAttachment);
    }

    public BaseAttachment getBaseAttachment(Integer attachmentId) {
        return cmsBaseAttachmentDao.getAttachmentById(attachmentId);
    }
    ...
    public BootstrapTableVo getAttachmentList(AttachmentDto attachmentDto) throws BusinessException {
        ...
        List<BaseAttachment> attachmentList = cmsBaseAttachmentDao.getAttachmentList(attachmentDto.getProcessInsId(), requestBaseParam.getSearch());
    ...
    public void deleteFileToServer(Integer id) throws Exception {
        BaseAttachment attachment = cmsBaseAttachmentDao.getAttachmentById(id);
        if (attachment == null) {
        ...
        if (!cmsBaseAttachmentDao.deleteAttachmentById(id)) {//删除数据库中记录
    ...
    public void deleteDataToServer(Integer id) throws Exception {
        BaseAttachment attachmentById = cmsBaseAttachmentDao.getAttachmentById(id);
    ...
    public BootstrapTableVo getAttachmentKeepList(Integer attachmentId) {
        ...
        BaseAttachment sysAttachment = cmsBaseAttachmentDao.getAttachmentById(attachmentId);
    ...
    public String getViewImageUrl(Integer id) {
        ...
        BaseAttachment sysAttachment = cmsBaseAttachmentDao.getAttachmentById(id);
    ...
    public void saveKeepFile(Integer attachmentId) throws Exception {
        ...
        cmsBaseAttachmentDao.updateAttachment(sysAttachment);
    }
    ...
    public void updateFileSize(Integer attachmentId, long size) {
        BaseAttachment baseAttachment = cmsBaseAttachmentDao.getAttachmentById(attachmentId);
        if (baseAttachment != null) {
            baseAttachment.setFileSize(FileUtils.getSize(size));
            cmsBaseAttachmentDao.updateAttachment(baseAttachment);
        }
    }
