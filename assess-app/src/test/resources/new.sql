...
CREATE TABLE `tb_assets_customize_data_field` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=441 DEFAULT CHARSET=utf8 COMMENT='自定义附件名称表';
...
CREATE TABLE `tb_base_assist` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=utf8 COMMENT='自定义Form配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=2129 DEFAULT CHARSET=utf8 COMMENT='数据字典';
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='系统附件模板';
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='参数表';
...
CREATE TABLE `tb_base_project_classify` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=358 DEFAULT CHARSET=utf8 COMMENT='项目分类';
...
) ENGINE=InnoDB AUTO_INCREMENT=2121 DEFAULT CHARSET=utf8 COMMENT='其他报告模板';
...
CREATE TABLE `tb_base_report_template` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='定义模板书签字段';
...
CREATE TABLE `tb_basic_apply` (
  ...
  `bis_delete` tinyint(1) DEFAULT '0',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1755 DEFAULT CHARSET=utf8 COMMENT='查勘数据关联表';
...
CREATE TABLE `tb_basic_apply_batch` (
  ...
  `province` varchar(100) DEFAULT NULL COMMENT '省',
  `city` varchar(100) DEFAULT NULL COMMENT '市',
  `classify` int(11) DEFAULT NULL COMMENT '大类 单套住宅 多套住宅 土地',
  ...
  `case_estate_id` int(11) DEFAULT NULL COMMENT '批量申请案例库楼盘id',
  `status` varchar(50) DEFAULT NULL COMMENT '流程状态',
  `draft_flag` tinyint(1) DEFAULT '0' COMMENT '草稿标志',
  `bis_delete` tinyint(1) DEFAULT '0',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2725 DEFAULT CHARSET=utf8 COMMENT='楼盘批量申请主表';
...
CREATE TABLE `tb_basic_apply_batch_detail` (
  ...
  `quote_id` int(11) DEFAULT NULL COMMENT '引用数据id',
  `base_type` varchar(50) DEFAULT NULL COMMENT '引用数据所属库',
  `case_table_pid` int(11) DEFAULT NULL COMMENT '案例tablePid',
  `upgrade_table_id` int(11) DEFAULT NULL COMMENT '案列升级数据id',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `bis_delete` tinyint(1) DEFAULT '0',
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4345 DEFAULT CHARSET=utf8 COMMENT='楼盘批量申请子表';
...
CREATE TABLE `tb_basic_building` (
  ...
  `land_use_year` decimal(11,2) DEFAULT NULL COMMENT '土地使用年限',
  ...
  `map_id` int(11) DEFAULT NULL COMMENT 'map id',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `bis_delete` tinyint(1) DEFAULT '0',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `relevance_id` int(11) DEFAULT NULL COMMENT '属于某id的旧数据',
  `display_case_id` int(11) DEFAULT NULL COMMENT '查看案列详情id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2247 DEFAULT CHARSET=utf8 COMMENT='楼栋';
...
CREATE TABLE `tb_basic_building_function` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1289 DEFAULT CHARSET=utf8 COMMENT='楼栋建筑功能';
...
CREATE TABLE `tb_basic_building_maintenance` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8 COMMENT='维护结构';
...
CREATE TABLE `tb_basic_building_outfit` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1085 DEFAULT CHARSET=utf8 COMMENT='楼栋外装情况';
...
CREATE TABLE `tb_basic_building_property_service_item` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=433 DEFAULT CHARSET=utf8 COMMENT='楼栋 物业服务内容';
...
CREATE TABLE `tb_basic_building_surface` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8 COMMENT='层面结构';
...
CREATE TABLE `tb_basic_estate` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `apply_id` int(11) DEFAULT NULL,
  `classify` int(11) DEFAULT NULL COMMENT '大类',
  ...
  `open_time` datetime DEFAULT NULL COMMENT '开盘时间',
  `building_number` int(20) DEFAULT NULL COMMENT '总栋数 ',
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `relevance_id` int(11) DEFAULT NULL COMMENT '属于某id的旧数据',
  `display_case_id` int(11) DEFAULT NULL COMMENT '查看案例详情id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3137 DEFAULT CHARSET=utf8 COMMENT='楼盘';
...
CREATE TABLE `tb_basic_estate_land_state` (
  ...
  `land_use_type` varchar(255) DEFAULT NULL COMMENT '土地用途类型',
  `land_use_category` varchar(255) DEFAULT NULL COMMENT '土地用途类别',
  ...
  `development_time` datetime DEFAULT NULL COMMENT '开发时间',
  `bis_delete` tinyint(1) DEFAULT '0',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2987 DEFAULT CHARSET=utf8 COMMENT='土地实体情况';
...
CREATE TABLE `tb_basic_estate_network` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2782 DEFAULT CHARSET=utf8 COMMENT='通信网络';
...
CREATE TABLE `tb_basic_estate_parking` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1245 DEFAULT CHARSET=utf8 COMMENT='车位信息';
...
CREATE TABLE `tb_basic_estate_tagging` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5403 DEFAULT CHARSET=utf8 COMMENT='楼盘标注信息';
...
CREATE TABLE `tb_basic_house` (
  ...
  `cert_use` varchar(255) DEFAULT NULL COMMENT '证载用途',
  `practical_use` varchar(255) DEFAULT NULL COMMENT '实际用途',
  ...
  `display_case_id` int(11) DEFAULT NULL COMMENT '查看案例详情id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2573 DEFAULT CHARSET=utf8 COMMENT='房屋';
...
CREATE TABLE `tb_basic_house_damaged_degree` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27616 DEFAULT CHARSET=utf8 COMMENT='房屋完损度';
...
CREATE TABLE `tb_basic_house_damaged_degree_detail` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1934 DEFAULT CHARSET=utf8 COMMENT='房屋完损度明细';
...
CREATE TABLE `tb_basic_house_equipment` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1825 DEFAULT CHARSET=utf8 COMMENT='设备 包含（空调、新风、供暖）';
...
CREATE TABLE `tb_basic_house_face_street` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=775 DEFAULT CHARSET=utf8 COMMENT='临街（路）状况';
...
CREATE TABLE `tb_basic_house_intelligent` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=914 DEFAULT CHARSET=utf8 COMMENT='电力通讯网络';
...
CREATE TABLE `tb_basic_house_room` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1844 DEFAULT CHARSET=utf8 COMMENT='房间';
...
CREATE TABLE `tb_basic_house_room_decorate` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3542 DEFAULT CHARSET=utf8 COMMENT='房间装修';
...
CREATE TABLE `tb_basic_house_trading` (
  ...
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `price_connotation_unit` varchar(50) DEFAULT NULL COMMENT '单价内涵单位',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2902 DEFAULT CHARSET=utf8 COMMENT='房屋交易信息';
...
CREATE TABLE `tb_basic_house_trading_lease` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COMMENT='房屋出租';
...
CREATE TABLE `tb_basic_house_trading_sell` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=451 DEFAULT CHARSET=utf8 COMMENT='房屋出售';
...
CREATE TABLE `tb_basic_house_water` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=842 DEFAULT CHARSET=utf8 COMMENT='供排水情况';
...
CREATE TABLE `tb_basic_house_water_drain` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1116 DEFAULT CHARSET=utf8 COMMENT='供排水情况';
...
CREATE TABLE `tb_basic_matching_education` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3070 DEFAULT CHARSET=utf8 COMMENT='教育条件';
...
CREATE TABLE `tb_basic_matching_environment` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2360 DEFAULT CHARSET=utf8 COMMENT='环境因素';
...
CREATE TABLE `tb_basic_matching_finance` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4044 DEFAULT CHARSET=utf8 COMMENT='金融服务';
...
CREATE TABLE `tb_basic_matching_leisure_place` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10406 DEFAULT CHARSET=utf8 COMMENT='休闲场所 包含-购物、娱乐、餐饮';
...
CREATE TABLE `tb_basic_matching_medical` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2445 DEFAULT CHARSET=utf8 COMMENT='医养条件';
...
CREATE TABLE `tb_basic_matching_traffic` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10499 DEFAULT CHARSET=utf8 COMMENT='交通条件';
...
CREATE TABLE `tb_basic_unit` (
  ...
  `display_case_id` int(11) DEFAULT NULL COMMENT '查看案例详情id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1923 DEFAULT CHARSET=utf8 COMMENT='单元';
...
CREATE TABLE `tb_basic_unit_decorate` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1145 DEFAULT CHARSET=utf8 COMMENT='室内公共装修';
...
CREATE TABLE `tb_basic_unit_elevator` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=847 DEFAULT CHARSET=utf8 COMMENT='配备电梯';
...
CREATE TABLE `tb_basic_unit_huxing` (
  ...
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `spatial_distribution` varchar(255) DEFAULT NULL COMMENT '空间布局',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=966 DEFAULT CHARSET=utf8 COMMENT='户型';

-- ----------------------------
-- Table structure for tb_basic_unit_huxing_price
-- ----------------------------
DROP TABLE IF EXISTS `tb_basic_unit_huxing_price`;
CREATE TABLE `tb_basic_unit_huxing_price` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `huxing_id` int(11) DEFAULT NULL,
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=921 DEFAULT CHARSET=utf8 COMMENT='户型';
...
CREATE TABLE `tb_compile_report` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8 COMMENT='报告编写';
...
CREATE TABLE `tb_compile_report_detail` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=788 DEFAULT CHARSET=utf8 COMMENT='报告编写明细';
...
CREATE TABLE `tb_data_best_use_description` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='最佳利用方式';
...
CREATE TABLE `tb_data_his_right_info_publicity` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=360 DEFAULT CHARSET=utf8 COMMENT='他权信息公示';
...
CREATE TABLE `tb_data_house_price_index_detail` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='房价指数 详情';
...
CREATE TABLE `tb_data_land_level` (
  ...
  `city` varchar(50) DEFAULT NULL COMMENT '市',
  `district` varchar(50) DEFAULT NULL COMMENT '区县',
  `town_ship_name` varchar(211) DEFAULT NULL COMMENT '乡镇名称',
  `release_date` datetime DEFAULT NULL COMMENT '发布日期',
  ...
  `land_right_type` int(11) DEFAULT NULL COMMENT '权利类型',
  `status` varchar(200) DEFAULT NULL COMMENT '流程状态',
  `process_ins_id` varchar(200) DEFAULT NULL COMMENT '流程实例id',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=363 DEFAULT CHARSET=utf8 COMMENT='土地级别';
...
CREATE TABLE `tb_data_land_level_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `pid` int(20) DEFAULT NULL COMMENT 'pid',
  `land_level_id` int(11) DEFAULT NULL,
  `classify` int(11) DEFAULT NULL COMMENT '大类',
  `type` int(11) DEFAULT NULL COMMENT '类型',
  `category` varchar(100) DEFAULT NULL COMMENT '类别',
  `price` decimal(20,5) DEFAULT NULL COMMENT '平方价',
  `mu_price` decimal(20,5) DEFAULT NULL COMMENT '每亩单价',
  `land_acquisition_proportion` varchar(255) DEFAULT NULL COMMENT '征地比例',
  `volume_rate` decimal(20,5) DEFAULT NULL COMMENT '容积率',
  `legal_age` decimal(20,5) DEFAULT NULL COMMENT '法定使用年限',
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=590 DEFAULT CHARSET=utf8 COMMENT='土地级别明细';

-- ----------------------------
-- Table structure for tb_data_land_level_detail_achievement
-- ----------------------------
DROP TABLE IF EXISTS `tb_data_land_level_detail_achievement`;
CREATE TABLE `tb_data_land_level_detail_achievement` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `achievement` decimal(11,2) DEFAULT NULL COMMENT '分值',
  `reamark` varchar(500) DEFAULT NULL COMMENT '说明',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7324 DEFAULT CHARSET=utf8 COMMENT='土地级别详情从表';

-- ----------------------------
-- Table structure for tb_data_land_level_detail_volume
-- ----------------------------
DROP TABLE IF EXISTS `tb_data_land_level_detail_volume`;
CREATE TABLE `tb_data_land_level_detail_volume` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `level_detail_id` int(11) DEFAULT NULL,
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4144 DEFAULT CHARSET=utf8 COMMENT='土地级别详情从表';
...
CREATE TABLE `tb_data_locale_survey_picture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='现场查勘图片模板';
...
CREATE TABLE `tb_data_set_use_field` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=444 DEFAULT CHARSET=utf8 COMMENT='市场比较法设定用途对应字段';
...
CREATE TABLE `tb_declare_apply` (
  ...
  `assess_organization` varchar(255) DEFAULT NULL COMMENT '评估机构',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=407 DEFAULT CHARSET=utf8 COMMENT='申报信息';

-- ----------------------------
-- Table structure for tb_declare_apply_detail
-- ----------------------------
DROP TABLE IF EXISTS `tb_declare_apply_detail`;
CREATE TABLE `tb_declare_apply_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) DEFAULT NULL COMMENT '项目id',
  `declare_id` int(11) DEFAULT NULL COMMENT '申报信息id',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  ...
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1234 DEFAULT CHARSET=utf8 COMMENT='申报信息 扩展';
...
CREATE TABLE `tb_declare_build_engineering_and_equipment_center` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1341 DEFAULT CHARSET=utf8 COMMENT='申报 中间表';
...
CREATE TABLE `tb_declare_realty_house_cert` (
  ...
  `cert_use_category` varchar(255) DEFAULT NULL COMMENT '房屋用途类别',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=917 DEFAULT CHARSET=utf8 COMMENT='房产房产证';
...
CREATE TABLE `tb_declare_realty_land_cert` (
  ...
  `cert_use` varchar(255) DEFAULT NULL COMMENT '证载用途（住宅用地,工矿仓储用地,商业用地,公共管理与公共服务用地,交通运输用地）',
  `cert_use_category` varchar(255) DEFAULT NULL COMMENT '证载用途类别',
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=522 DEFAULT CHARSET=utf8 COMMENT='房产 土地证';
...
CREATE TABLE `tb_declare_realty_real_estate_cert` (
  ...
  `registration_time` datetime DEFAULT NULL COMMENT '登记时间',
  `nature` int(11) DEFAULT NULL COMMENT '房屋性质',
  `house_cert_use` varchar(255) DEFAULT NULL COMMENT '房屋用途',
  `housing_structure` varchar(255) DEFAULT NULL COMMENT '房屋结构',
  ...
  `land_cert_use` varchar(255) DEFAULT NULL COMMENT '土地用途',
  `land_cert_use_category` varchar(255) DEFAULT NULL COMMENT '土地用途类型',
  `termination_date` datetime DEFAULT NULL COMMENT '终止日期',
  `memo` varchar(255) DEFAULT NULL COMMENT '记事',
  `apportionment_area` decimal(20,2) DEFAULT NULL COMMENT '分摊面积',
  `acreage` decimal(20,2) DEFAULT NULL COMMENT '独用面积',
  ...
  `house_cert_use_category` varchar(255) DEFAULT NULL COMMENT '房屋用途类别',
  `acquisition_type` varchar(50) DEFAULT NULL COMMENT '土地取得方式',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=829 DEFAULT CHARSET=utf8 COMMENT='房产 不动产';
...
CREATE TABLE `tb_declare_record` (
  ...
  `city` varchar(50) DEFAULT NULL COMMENT '市',
  `district` varchar(50) DEFAULT NULL COMMENT '区县',
  `type` varchar(255) DEFAULT NULL COMMENT '类型(房产证、土地证、不动产证)',
  ...
  `land_cert_use_category` varchar(255) DEFAULT NULL COMMENT '土地用途类别',
  ...
  `housing_structure` varchar(255) DEFAULT NULL COMMENT '房屋结构',
  `group_id` int(11) DEFAULT NULL COMMENT '申报阶段的一次分组==申报记录(2019-10-15添加的字段)',
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=990 DEFAULT CHARSET=utf8 COMMENT='申报记录';
...
CREATE TABLE `tb_declare_record_extend` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 COMMENT='申报记录扩展';

-- ----------------------------
-- Table structure for tb_declare_record_group
-- ----------------------------
DROP TABLE IF EXISTS `tb_declare_record_group`;
CREATE TABLE `tb_declare_record_group` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=231 DEFAULT CHARSET=utf8 COMMENT='资产申报分组';
...
CREATE TABLE `tb_document_opinion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='征求意见稿';
...
CREATE TABLE `tb_document_send` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='项目发文';
...
CREATE TABLE `tb_document_template` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='发文模板';
...
CREATE TABLE `tb_document_template_bookmark` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='发文书签';
...
CREATE TABLE `tb_document_template_field` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='发文字段';
...
CREATE TABLE `tb_funi_block` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8 COMMENT='板块';
...
CREATE TABLE `tb_funi_developers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1936 DEFAULT CHARSET=utf8 COMMENT='开发商';
...
CREATE TABLE `tb_funi_property_management` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=867 DEFAULT CHARSET=utf8 COMMENT='物业公司';
...
CREATE TABLE `tb_generate_report_info` (
  ...
  `symbol_operation` varchar(255) DEFAULT NULL COMMENT '文号操作(get表示拿号,reset表示重新拿号,none表示不拿号)',
  `status` varchar(100) DEFAULT NULL COMMENT '流程状态',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=422 DEFAULT CHARSET=utf8 COMMENT='报告生成';
...
CREATE TABLE `tb_initiate_consignor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=682 DEFAULT CHARSET=utf8 COMMENT='立项委托人';
...
CREATE TABLE `tb_initiate_contacts` (
  ...
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3874 DEFAULT CHARSET=utf8 COMMENT='立项联系人信息';
...
CREATE TABLE `tb_initiate_possessor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=682 DEFAULT CHARSET=utf8 COMMENT='立项占有人';
...
CREATE TABLE `tb_initiate_unit_information` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=681 DEFAULT CHARSET=utf8 COMMENT='立项报告使用单位';
...
CREATE TABLE `tb_md_architectural_obj` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1262 DEFAULT CHARSET=utf8 COMMENT='建筑安装工程费或者成新率或者其他什么的';
...
CREATE TABLE `tb_md_base_land_price` (
  ...
  `standard_premium_remark` varchar(255) DEFAULT NULL COMMENT '基准地价说明',
  `legal_age` decimal(13,2) DEFAULT NULL COMMENT '法定年限',
  `legal_age_remark` varchar(255) DEFAULT NULL COMMENT '法定年限说明',
  `land_surplus_year` decimal(13,2) DEFAULT NULL COMMENT '剩余使用年限',
  `land_surplus_year_remark` varchar(255) DEFAULT NULL COMMENT '剩余使用年限说明',
  `period_amend` decimal(13,4) DEFAULT NULL COMMENT '年期修正系数',
  `develop_correct` decimal(13,2) DEFAULT NULL COMMENT '开发程度修正',
  `develop_correct_remark` varchar(255) DEFAULT NULL COMMENT '开发程度修正说明',
  `volumetric_rate` decimal(13,2) DEFAULT NULL COMMENT '委估对象容积率',
  `volumetric_rate_remark` varchar(255) DEFAULT NULL COMMENT '委估对象容积率说明',
  `evaluation_area` decimal(13,2) DEFAULT NULL COMMENT '委估宗地面积',
  `evaluation_area_remark` varchar(255) DEFAULT NULL COMMENT '宗地面积说明',
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='基准地价系数修正法';
...
CREATE TABLE `tb_md_calculating_method_engineering_cost` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=741 DEFAULT CHARSET=utf8 COMMENT='测算方法 工程费';
...
CREATE TABLE `tb_md_cost` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='成本法';
...
CREATE TABLE `tb_md_cost_approach` (
  ...
  `plan_details_id` int(11) DEFAULT NULL,
  `process_ins_id` varchar(100) DEFAULT NULL COMMENT '流程实例id',
  `farmland_area` decimal(13,2) DEFAULT NULL COMMENT '农用地面积',
  `plough_area` decimal(13,2) DEFAULT NULL COMMENT '耕地面积',
  `population_number` int(11) DEFAULT NULL COMMENT '人口数',
  `reward_rate_id` int(11) DEFAULT NULL COMMENT '还原率id',
  `reward_rate` varchar(100) DEFAULT NULL COMMENT '还原率',
  `circulation_expense` decimal(13,2) DEFAULT NULL COMMENT '宗地外流通费用',
  `circulation_expense_remark` varchar(255) DEFAULT NULL COMMENT '宗地外六通费用说明',
  `flat_expense` decimal(13,2) DEFAULT NULL COMMENT '场平费用',
  `flat_expense_remark` varchar(255) DEFAULT NULL COMMENT '场平费用说明',
  `machine_cycle` decimal(13,2) DEFAULT NULL COMMENT '计息周期',
  `machine_cycle_remark` varchar(255) DEFAULT NULL COMMENT '计算周期说明',
  `calculated_interest` varchar(100) DEFAULT NULL COMMENT '计算利息',
  `calculated_interest_remark` varchar(255) DEFAULT NULL COMMENT '计算利息说明',
  `profit_margin` varchar(100) DEFAULT NULL COMMENT '利润率',
  `profit_margin_remark` varchar(255) DEFAULT NULL COMMENT '利润率说明',
  `incremental_benefit` varchar(100) DEFAULT NULL COMMENT '土地增值率',
  `incremental_benefit_remark` varchar(255) DEFAULT NULL COMMENT '土地增值率说明',
  `plot_ratio_adjust` varchar(100) DEFAULT NULL COMMENT '容积率调整',
  `plot_ratio_adjust_remark` varchar(255) DEFAULT NULL COMMENT '容积率调整说明',
  `plot_ratio_element_amend` decimal(13,2) DEFAULT NULL COMMENT '容积率个别因素修正',
  `plot_ratio_element_amend_remark` varchar(255) DEFAULT NULL COMMENT '容积率个别因素修正说明',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `land_remaining_year` decimal(13,2) DEFAULT NULL COMMENT '剩余年限',
  `land_remaining_year_remark` varchar(255) DEFAULT NULL COMMENT '剩余年限说明',
  `parcel_setting_outer` varchar(255) DEFAULT NULL COMMENT '宗地外设定',
  `parcel_setting_inner` varchar(255) DEFAULT NULL COMMENT '宗地内设定',
  `land_level_content` json DEFAULT NULL COMMENT '修正明细',
  `land_use_price` decimal(13,2) DEFAULT NULL COMMENT '无限年期土地使用权价格',
  `year_fixed` decimal(13,4) DEFAULT NULL COMMENT '年期修正系数',
  `parcel_unit` decimal(13,2) DEFAULT NULL COMMENT '委估宗地单价',
  `land_cost_price_unit` decimal(13,2) DEFAULT NULL COMMENT '土地取得成本',
  `land_acquisition_unit` decimal(13,2) DEFAULT NULL COMMENT '土地取得费及相关税费',
  `land_production_profit_unit` decimal(13,2) DEFAULT NULL COMMENT '土地开发利润',
  `land_production_interest_unit` decimal(13,2) DEFAULT NULL COMMENT '土地开发利息',
  `have_not_land_acquisition` decimal(13,2) DEFAULT NULL COMMENT '不含代征地每平税费',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='成本逼近法测算表';

-- ----------------------------
-- Table structure for tb_md_cost_approach_item
-- ----------------------------
DROP TABLE IF EXISTS `tb_md_cost_approach_item`;
CREATE TABLE `tb_md_cost_approach_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `master_id` int(11) DEFAULT NULL COMMENT '主表id',
  `year_describe` varchar(255) DEFAULT NULL COMMENT '年份描述',
  `average_production` decimal(18,2) DEFAULT NULL COMMENT '平均产值',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='成本逼近法测算表生产明细';

-- ----------------------------
-- Table structure for tb_md_cost_approach_taxes
-- ----------------------------
DROP TABLE IF EXISTS `tb_md_cost_approach_taxes`;
CREATE TABLE `tb_md_cost_approach_taxes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `master_id` int(11) DEFAULT NULL COMMENT '主表id',
  `type_name` varchar(255) DEFAULT NULL COMMENT '类型',
  `type_key` varchar(255) DEFAULT NULL COMMENT '类型key',
  `standard_first` decimal(18,2) DEFAULT NULL COMMENT '标准1',
  `standard_second` decimal(18,2) DEFAULT NULL COMMENT '标准2',
  `price` decimal(18,2) DEFAULT NULL COMMENT '金额',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1173 DEFAULT CHARSET=utf8 COMMENT='成本逼近法测算表税费配置';
...
CREATE TABLE `tb_md_cost_construction` (
  ...
  `residue_ratio_remark` varchar(255) DEFAULT NULL COMMENT '成新率备注说明',
  `residue_ratio` decimal(20,4) DEFAULT NULL COMMENT '成新率',
  `pid` int(12) DEFAULT NULL COMMENT '成本法id',
  `center_id` int(11) DEFAULT NULL COMMENT '申报对象中间表id',
  `json_content` json DEFAULT NULL COMMENT 'json数据',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 COMMENT='成本法测算表';
...
CREATE TABLE `tb_md_development` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8 COMMENT='假设开发法';
...
CREATE TABLE `tb_md_development_infrastructure_children` (
  ...
  `pid` int(11) DEFAULT NULL COMMENT '关联主键',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=587 DEFAULT CHARSET=utf8 COMMENT='假设开发法 配套设施费用';
...
CREATE TABLE `tb_md_economic_indicators` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3029 DEFAULT CHARSET=utf8 COMMENT='经济规划指标';
...
CREATE TABLE `tb_md_economic_indicators_item` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3496 DEFAULT CHARSET=utf8 COMMENT='经济规划指标';
...
CREATE TABLE `tb_md_income` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=373 DEFAULT CHARSET=utf8 COMMENT='收益法主表';
...
CREATE TABLE `tb_md_income_date_section` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=268 DEFAULT CHARSET=utf8 COMMENT='收益法时间分段';
...
CREATE TABLE `tb_md_income_forecast` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=400 DEFAULT CHARSET=utf8 COMMENT='自营费用信息';
...
CREATE TABLE `tb_md_income_forecast_analyse` (
  ...
  `financial_cost_ratio` decimal(18,4) DEFAULT NULL COMMENT '财务费用比率',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=495 DEFAULT CHARSET=utf8 COMMENT='自营费用信息';
...
CREATE TABLE `tb_md_income_forecast_analyse_item` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1457 DEFAULT CHARSET=utf8 COMMENT='预测分析数据明细';
...
CREATE TABLE `tb_md_income_forecast_item` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=150 DEFAULT CHARSET=utf8 COMMENT='有效毛收入明细';
...
CREATE TABLE `tb_md_income_forecast_year` (
  ...
  `income_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2196 DEFAULT CHARSET=utf8 COMMENT='自营费用信息';
...
CREATE TABLE `tb_md_income_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1271 DEFAULT CHARSET=utf8 COMMENT='自营费用信息';
...
CREATE TABLE `tb_md_income_lease` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=387 DEFAULT CHARSET=utf8 COMMENT='租赁收入';
...
CREATE TABLE `tb_md_income_lease_cost` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=387 DEFAULT CHARSET=utf8 COMMENT='租赁成本';
...
CREATE TABLE `tb_md_income_price_investigation` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='商品价格调查';
...
CREATE TABLE `tb_md_market_compare` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=648 DEFAULT CHARSET=utf8 COMMENT='比较法';
...
CREATE TABLE `tb_md_market_compare_item` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1177 DEFAULT CHARSET=utf8 COMMENT='比较法明细';

-- ----------------------------
-- Table structure for tb_net_info_assign_task
-- ----------------------------
DROP TABLE IF EXISTS `tb_net_info_assign_task`;
CREATE TABLE `tb_net_info_assign_task` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `net_info_ids` varchar(2000) DEFAULT NULL COMMENT '数据ids',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='拍卖信息任务分派';
...
CREATE TABLE `tb_net_info_record` (
  ...
  `area` decimal(10,2) DEFAULT NULL COMMENT '面积',
  `negotiated_total_price` decimal(18,6) DEFAULT NULL COMMENT '协商总价',
  `negotiated_date` datetime DEFAULT NULL COMMENT '协商日期',
  `status` int(11) DEFAULT '0' COMMENT '状态 0初始化 1已分派 2填写完成 3审批中 4审批通过',
  `executor` varchar(50) DEFAULT NULL COMMENT '执行人',
  `belong_type` varchar(50) DEFAULT NULL COMMENT '房产、土地',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=719472 DEFAULT CHARSET=utf8 COMMENT='网络案例记录表';
...
CREATE TABLE `tb_net_info_record_content` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=648935 DEFAULT CHARSET=utf8 COMMENT='网络案例内容明细表';

-- ----------------------------
-- Table structure for tb_net_info_record_house
-- ----------------------------
DROP TABLE IF EXISTS `tb_net_info_record_house`;
CREATE TABLE `tb_net_info_record_house` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `master_id` int(11) DEFAULT NULL,
  `type` varchar(50) DEFAULT '房产',
  `province` varchar(50) DEFAULT NULL COMMENT '省',
  `city` varchar(50) DEFAULT NULL COMMENT '市',
  `district` varchar(50) DEFAULT NULL COMMENT '区',
  `belong_type` varchar(50) DEFAULT NULL COMMENT '房产类型',
  `belong_category` varchar(50) DEFAULT NULL COMMENT '房产类别',
  ...
  `deal_type` int(11) DEFAULT NULL COMMENT '交易方式',
  `current_price` decimal(11,2) DEFAULT NULL COMMENT '成交价',
  `negotiated_date` datetime DEFAULT NULL COMMENT '成交(协商)日期',
  `consult_price` decimal(11,2) DEFAULT NULL COMMENT '评估价',
  `assess_standard_date` datetime DEFAULT NULL COMMENT '评估基准日',
  `unit_price` decimal(11,2) DEFAULT NULL COMMENT '单价',
  `house_realization_ratios` decimal(11,2) DEFAULT NULL COMMENT '变现率',
  `realization_cycle` varchar(50) DEFAULT NULL COMMENT '变现周期',
  `deal_part_info` varchar(500) DEFAULT NULL COMMENT '成交对象概况',
  `status` int(11) DEFAULT '0' COMMENT '1审批通过 2审批中',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `building_number` varchar(50) DEFAULT NULL COMMENT '楼栋号',
  `unit_number` varchar(50) DEFAULT NULL COMMENT '单元号',
  `house_number` varchar(50) DEFAULT NULL COMMENT '房号',
  `approver` varchar(50) DEFAULT NULL COMMENT '审批人',
  `trading_type` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='网络案例房产信息表';

-- ----------------------------
-- Table structure for tb_net_info_record_land
-- ----------------------------
DROP TABLE IF EXISTS `tb_net_info_record_land`;
CREATE TABLE `tb_net_info_record_land` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `master_id` int(11) DEFAULT NULL,
  `type` varchar(50) DEFAULT '土地',
  `province` varchar(50) DEFAULT NULL COMMENT '省',
  `city` varchar(50) DEFAULT NULL COMMENT '市',
  `district` varchar(50) DEFAULT NULL COMMENT '区',
  `belong_type` varchar(50) DEFAULT NULL COMMENT '土地类型',
  `belong_category` varchar(50) DEFAULT NULL COMMENT '土地类别',
  `land_purpose` varchar(255) DEFAULT NULL COMMENT '土地性质',
  `street` varchar(255) DEFAULT NULL COMMENT '街道',
  `area` decimal(11,2) DEFAULT NULL COMMENT '面积',
  `area_unit` varchar(50) DEFAULT NULL COMMENT '单位（平方米、亩）',
  `name` varchar(255) DEFAULT NULL COMMENT '地块名称',
  `parcel_number` varchar(255) DEFAULT NULL COMMENT '宗地编号',
  `parcel_site` varchar(255) DEFAULT NULL COMMENT '宗地位置',
  `deal_type` int(11) DEFAULT NULL COMMENT '交易方式',
  `current_price` decimal(11,2) DEFAULT NULL COMMENT '成交价',
  `negotiated_date` datetime DEFAULT NULL COMMENT '成交(协商)日期',
  `consult_price` decimal(11,2) DEFAULT NULL COMMENT '评估价',
  `assess_standard_date` datetime DEFAULT NULL COMMENT '评估基准日',
  `unit_price` decimal(11,2) DEFAULT NULL COMMENT '单价',
  `floor_price` decimal(11,2) DEFAULT NULL COMMENT '楼面地价',
  `land_realization_ratios` decimal(11,2) DEFAULT NULL COMMENT '变现率',
  `realization_cycle` varchar(50) DEFAULT NULL COMMENT '变现周期',
  `land_area` decimal(11,2) DEFAULT NULL COMMENT '净用地面积',
  `plot_ratio` int(11) DEFAULT NULL COMMENT '容积率',
  `plot_ratio_remark` varchar(500) DEFAULT NULL COMMENT '容积率说明',
  `greening_rate` decimal(11,2) DEFAULT NULL COMMENT '绿化率',
  `greening_rate_remark` varchar(500) DEFAULT NULL COMMENT '绿化率说明',
  `build_density` decimal(11,2) DEFAULT NULL COMMENT '建筑密度',
  `build_density_remark` varchar(500) DEFAULT NULL COMMENT '建筑密度说明',
  `build_height` decimal(11,2) DEFAULT NULL COMMENT '建筑高度',
  `build_height_remark` varchar(500) DEFAULT NULL COMMENT '建筑高度说明',
  `index_amount` decimal(11,2) DEFAULT NULL COMMENT '指标款(亩)',
  `index_amount_remark` varchar(500) DEFAULT NULL COMMENT '指标款说明',
  `deal_part_info` varchar(500) DEFAULT NULL COMMENT '成交对象概况',
  `status` int(11) DEFAULT '0' COMMENT '1审批通过 2审批中 ',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `approver` varchar(50) DEFAULT NULL COMMENT '审批人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='网络案例土地信息表';
...
CREATE TABLE `tb_project_info` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=754 DEFAULT CHARSET=utf8 COMMENT='项目信息';
...
CREATE TABLE `tb_project_member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=686 DEFAULT CHARSET=utf8 COMMENT='项目成员信息';
...
CREATE TABLE `tb_project_member_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='项目组成员修改记录';
...
CREATE TABLE `tb_project_number_record` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 COMMENT='文号记录';
...
CREATE TABLE `tb_project_number_record_history` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=utf8 COMMENT='文号历史记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8 COMMENT='工作事项';
...
CREATE TABLE `tb_project_plan` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8721 DEFAULT CHARSET=utf8 COMMENT='项目计划';
...
CREATE TABLE `tb_project_plan_details` (
  ...
  `plan_remarks` varchar(8000) DEFAULT NULL COMMENT '计划说明',
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17681 DEFAULT CHARSET=utf8 COMMENT='项目计划明细';
...
CREATE TABLE `tb_project_qrcode_record` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8 COMMENT='文号规则';
...
CREATE TABLE `tb_project_subsequent` (
  ...
  `modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='项目后续事项';
...
CREATE TABLE `tb_project_take_number` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='项目拿号';
...
CREATE TABLE `tb_project_task_return_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=338 DEFAULT CHARSET=utf8 COMMENT='重启记录';
...
CREATE TABLE `tb_report_project_debt` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2318 DEFAULT CHARSET=utf8 COMMENT='项目欠款报表';
...
CREATE TABLE `tb_scheme_area_group` (
  ...
  `scope_include` varchar(255) DEFAULT NULL COMMENT '范围包含',
  `scope_not_include` varchar(255) DEFAULT NULL COMMENT '范围不包含',
  `bis_new` bit(1) DEFAULT b'0' COMMENT '是否最新产生',
  `bis_enable` bit(1) DEFAULT b'1' COMMENT '是否可用',
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=463 DEFAULT CHARSET=utf8 COMMENT='方案区域分组';
...
CREATE TABLE `tb_scheme_info` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=803 DEFAULT CHARSET=utf8 COMMENT='方案信息';
...
CREATE TABLE `tb_scheme_judge_function` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1958 DEFAULT CHARSET=utf8 COMMENT='估计对象评估方法与思路';
...
CREATE TABLE `tb_scheme_judge_object` (
  ...
  `judge_function` varchar(255) DEFAULT NULL COMMENT '选用的评估方法',
  `not_applicable_reason` varchar(2000) DEFAULT NULL COMMENT '评估方法不适用原因',
  `merge_explain` varchar(500) DEFAULT NULL COMMENT '对象合并说明',
  `split_explain` varchar(500) DEFAULT NULL COMMENT '拆分说明',
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=867 DEFAULT CHARSET=utf8 COMMENT='估价对象';

-- ----------------------------
-- Table structure for tb_scheme_judge_object_history
-- ----------------------------
DROP TABLE IF EXISTS `tb_scheme_judge_object_history`;
CREATE TABLE `tb_scheme_judge_object_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `judge_object_id` int(11) DEFAULT NULL,
  `project_id` int(11) DEFAULT NULL COMMENT '项目id',
  `area_group_id` int(11) DEFAULT NULL COMMENT '区域分组id',
  `declare_record_id` int(11) DEFAULT NULL COMMENT '申报记录id',
  `number` varchar(1000) DEFAULT NULL COMMENT '委估对象编号',
  `split_number` int(11) DEFAULT NULL COMMENT '拆分编号',
  `name` varchar(2000) DEFAULT NULL COMMENT '权证名称',
  `judge_function` varchar(255) DEFAULT NULL COMMENT '采用的估价方法',
  `sorting` int(11) DEFAULT NULL COMMENT '排序',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=988 DEFAULT CHARSET=utf8 COMMENT='估价对象';
...
CREATE TABLE `tb_scheme_liquidation_analysis` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=175 DEFAULT CHARSET=utf8 COMMENT='变现分析税费';
...
CREATE TABLE `tb_scheme_liquidation_analysis_group` (
  ...
  `area` decimal(11,2) DEFAULT NULL COMMENT '面积',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=278 DEFAULT CHARSET=utf8 COMMENT='变现分析税费分组';
...
CREATE TABLE `tb_scheme_liquidation_analysis_item` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1784 DEFAULT CHARSET=utf8 COMMENT='变现分析税费明细';

-- ----------------------------
-- Table structure for tb_scheme_liquidation_analysis_judge
-- ----------------------------
DROP TABLE IF EXISTS `tb_scheme_liquidation_analysis_judge`;
CREATE TABLE `tb_scheme_liquidation_analysis_judge` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `area_id` int(11) DEFAULT NULL COMMENT '区域id',
  `judge_object_id` int(11) DEFAULT NULL COMMENT '委估对象id',
  `plan_details_id` int(11) DEFAULT NULL COMMENT '方法名称',
  ...
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `name` varchar(100) DEFAULT NULL COMMENT '估价对象名称',
  `cert_name` varchar(100) DEFAULT NULL COMMENT '权证名称',
  `ownership` varchar(100) DEFAULT NULL COMMENT '所有权人',
  `seat` varchar(100) DEFAULT NULL COMMENT '坐落',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=395 DEFAULT CHARSET=utf8 COMMENT='变现分析税费分组';
...
CREATE TABLE `tb_scheme_reimbursement` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8 COMMENT='法定优先受偿款';
...
CREATE TABLE `tb_scheme_reimbursement_item` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=175 DEFAULT CHARSET=utf8 COMMENT='法定优先受偿款明细';
...
CREATE TABLE `tb_scheme_report_file_custom` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='报告自定义块附件';
...
CREATE TABLE `tb_scheme_report_file_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=380 DEFAULT CHARSET=utf8 COMMENT='报告附件明细项';
...
CREATE TABLE `tb_scheme_sure_price` (
  ...
  `process_ins_id` varchar(64) DEFAULT NULL COMMENT '流程实例id',
  `status` varchar(50) DEFAULT NULL COMMENT '流程状态',
  `weight_explain` varchar(1000) DEFAULT NULL COMMENT '权重说明',
  `price` decimal(13,2) DEFAULT NULL COMMENT '委估对象单价',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=186 DEFAULT CHARSET=utf8 COMMENT='确定单价';
...
CREATE TABLE `tb_scheme_sure_price_factor` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=470 DEFAULT CHARSET=utf8 COMMENT='确定单价因素';
...
CREATE TABLE `tb_scheme_sure_price_item` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1261 DEFAULT CHARSET=utf8 COMMENT='确定单价明细';
...
CREATE TABLE `tb_scheme_sure_price_record` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='确定单价记录';
...
CREATE TABLE `tb_survey_asset_inventory` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=474 DEFAULT CHARSET=utf8 COMMENT='资产清查';
...
CREATE TABLE `tb_survey_asset_inventory_content` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2891 DEFAULT CHARSET=utf8 COMMENT='清查核对记录';
...
CREATE TABLE `tb_survey_asset_inventory_right` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=624 DEFAULT CHARSET=utf8 COMMENT='他项权利';
...
CREATE TABLE `tb_survey_asset_inventory_right_record` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=905 DEFAULT CHARSET=utf8 COMMENT='他项权利申报表(他权组)';
...
CREATE TABLE `tb_survey_asset_inventory_right_record_center` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=735 DEFAULT CHARSET=utf8 COMMENT='他项权利申报表(center)';

-- ----------------------------
-- Table structure for tb_survey_asset_right
-- ----------------------------
DROP TABLE IF EXISTS `tb_survey_asset_right`;
CREATE TABLE `tb_survey_asset_right` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `plan_id` int(11) DEFAULT NULL COMMENT '计划id',
  `project_id` int(11) DEFAULT NULL COMMENT '项目id',
  `process_ins_id` varchar(64) DEFAULT NULL COMMENT '流程实例id',
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1156 DEFAULT CHARSET=utf8 COMMENT='他项权利申报表  主表';

-- ----------------------------
-- Table structure for tb_survey_asset_right_declare
-- ----------------------------
DROP TABLE IF EXISTS `tb_survey_asset_right_declare`;
CREATE TABLE `tb_survey_asset_right_declare` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `declare_name` varchar(255) DEFAULT NULL COMMENT '申报记录名称',
  `declare_id` int(11) DEFAULT NULL COMMENT '申报记录id',
  `building_name` varchar(255) DEFAULT NULL COMMENT '楼栋名称',
  `building_number` int(11) DEFAULT NULL COMMENT '楼栋号码',
  `unit_number` varchar(255) DEFAULT NULL COMMENT '单元号',
  `ownership` varchar(255) DEFAULT NULL COMMENT '所有权人',
  `seat` varchar(255) DEFAULT NULL COMMENT '坐落',
  `plan_details_id` int(11) DEFAULT NULL COMMENT '任务详情id',
  `group_id` int(11) DEFAULT NULL COMMENT '分组id',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=595 DEFAULT CHARSET=utf8 COMMENT='他项权利 申报记录';

-- ----------------------------
-- Table structure for tb_survey_asset_right_group
-- ----------------------------
DROP TABLE IF EXISTS `tb_survey_asset_right_group`;
CREATE TABLE `tb_survey_asset_right_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `project_id` int(11) DEFAULT NULL COMMENT '项目id',
  `master_id` int(12) DEFAULT NULL COMMENT '主表id',
  `plan_details_id` int(11) DEFAULT NULL COMMENT '计划明细id',
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1184 DEFAULT CHARSET=utf8 COMMENT='他项权利申报表(他权组)';

-- ----------------------------
-- Table structure for tb_survey_asset_right_item
-- ----------------------------
DROP TABLE IF EXISTS `tb_survey_asset_right_item`;
CREATE TABLE `tb_survey_asset_right_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `project_id` int(11) DEFAULT NULL COMMENT '项目id',
  `plan_details_id` int(11) DEFAULT NULL COMMENT '计划明细id',
  `group_id` int(12) DEFAULT NULL COMMENT 'group id',
  `cert_name` varchar(255) DEFAULT NULL COMMENT '权证名称',
  `type` int(11) DEFAULT NULL COMMENT '类型',
  `category` int(11) DEFAULT NULL COMMENT '类别',
  `number` varchar(100) DEFAULT NULL COMMENT '他权证编号',
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=846 DEFAULT CHARSET=utf8 COMMENT='他项权利详情表';
...
CREATE TABLE `tb_task_case_assign` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='案例参考数据分派任务';

-- ----------------------------
-- Table structure for tb_tool_map_handle
-- ----------------------------
DROP TABLE IF EXISTS `tb_tool_map_handle`;
CREATE TABLE `tb_tool_map_handle` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `table_id` int(11) DEFAULT NULL COMMENT '目标id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=211 DEFAULT CHARSET=utf8 COMMENT='地图工具';
...
CREATE TABLE `tb_tool_residue_ratio` (
  ...
  `gmt_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  `residual_ratio` decimal(18,2) DEFAULT NULL COMMENT '残值率',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=167 DEFAULT CHARSET=utf8 COMMENT='成新率';
...
CREATE TABLE `tb_tool_residue_ratio_observe` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=681 DEFAULT CHARSET=utf8 COMMENT='报酬率观察法明细';
...
CREATE TABLE `tb_tool_reward_rate` (
  ...
  `gmt_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=288 DEFAULT CHARSET=utf8 COMMENT='报酬率';

-- ----------------------------
-- View structure for vw_db_columns_info
-- ----------------------------
DROP VIEW IF EXISTS `vw_db_columns_info`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `vw_db_columns_info` AS select `information_schema`.`columns`.`COLUMN_NAME` AS `column_name`,`information_schema`.`columns`.`COLUMN_COMMENT` AS `column_comment`,`information_schema`.`columns`.`DATA_TYPE` AS `data_type`,`information_schema`.`columns`.`TABLE_NAME` AS `table_name`,`information_schema`.`columns`.`TABLE_SCHEMA` AS `table_schema` from `information_schema`.`columns` where (`information_schema`.`columns`.`TABLE_SCHEMA` = 'pmcc_chks') ;

-- ----------------------------
-- View structure for vw_db_table_info
-- ----------------------------
DROP VIEW IF EXISTS `vw_db_table_info`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `vw_db_table_info` AS select `information_schema`.`tables`.`TABLE_NAME` AS `TABLE_NAME`,`information_schema`.`tables`.`TABLE_COMMENT` AS `TABLE_COMMENT` from `information_schema`.`tables` where (`information_schema`.`tables`.`TABLE_SCHEMA` = 'pmcc_chks') ;
