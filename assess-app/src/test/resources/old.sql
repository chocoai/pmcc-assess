...
Source Host           : 192.168.2.201:3305
...
CREATE TABLE `tb_hr_admission_bookmark` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='面试通知模板书签';
...
CREATE TABLE `tb_hr_admission_file` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='面试通知模板';
...
CREATE TABLE `tb_hr_annual_leave_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='年假记录';
...
CREATE TABLE `tb_hr_attendance_analyze` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33978 DEFAULT CHARSET=utf8 COMMENT='考勤数据分析';
...
CREATE TABLE `tb_hr_attendance_checkin` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13749 DEFAULT CHARSET=utf8 COMMENT='钉钉签到记录表';
...
CREATE TABLE `tb_hr_attendance_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20775 DEFAULT CHARSET=utf8 COMMENT='钉钉考勤记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=319 DEFAULT CHARSET=utf8 COMMENT='数据字典';
...
CREATE TABLE `tb_hr_base_position` (
  ...
  `bis_enable` bit(1) DEFAULT b'1' COMMENT '是否有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='职级信息表';
...
CREATE TABLE `tb_hr_base_post` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='岗位信息表';
...
CREATE TABLE `tb_hr_base_post_grade` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='岗级信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='工作事项';
...
CREATE TABLE `tb_hr_base_process_form` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='工作事项具体工作项';
...
CREATE TABLE `tb_hr_emergency` (
  ...
  `matter` varchar(300) DEFAULT NULL COMMENT '地点',
  `report_object` varchar(100) DEFAULT NULL COMMENT '报告对象',
  `impacted_impact` varchar(300) DEFAULT NULL COMMENT '事件影响',
  `suggest_process_mode` varchar(300) DEFAULT NULL COMMENT '建议处理方式',
  `scene_dispose_status` varchar(300) DEFAULT NULL COMMENT '现场处理状况',
  ...
  `creator_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '申请人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_hr_hiring_requisition` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='招聘申请';
...
CREATE TABLE `tb_hr_hiring_requisition_detail` (
  ...
  `gmt_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='招聘申请明细';
...
CREATE TABLE `tb_hr_holiday_manage` (
  ...
  `creator` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='节假日维护';
...
CREATE TABLE `tb_hr_interview_question` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='面试题库';
...
CREATE TABLE `tb_hr_interview_record_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='面试记录明细';
...
CREATE TABLE `tb_hr_interview_record_sign` (
  ...
  `interview_idea_name` varchar(50) DEFAULT NULL COMMENT '面试意见',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='面试记录会签';
...
CREATE TABLE `tb_hr_legwork` (
  ...
  `legwork_vehicle` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '交通工具',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8 COMMENT='外勤内容';
...
CREATE TABLE `tb_hr_legwork_single` (
  ...
  `bis_expends` bit(1) DEFAULT b'0' COMMENT '是否报销',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 COMMENT='外勤人员单独时间段设置';
...
CREATE TABLE `tb_hr_overtime` (
  ...
  `is_valid` bit(1) DEFAULT b'1' COMMENT '是否有效（0：无效 1：有效）默认有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=355 DEFAULT CHARSET=utf8 COMMENT='加班信息表';
...
CREATE TABLE `tb_hr_overtime_result` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='加班成果会签';
...
CREATE TABLE `tb_hr_overtime_result_process` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='加班成果审批';
...
CREATE TABLE `tb_hr_overtime_single` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=477 DEFAULT CHARSET=utf8 COMMENT='加班人员时间段设置表';
...
CREATE TABLE `tb_hr_provident_fund` (
  ...
  `personal_sustain` decimal(10,2) DEFAULT NULL,
  `company_personal_sustain` decimal(10,2) DEFAULT NULL,
  `subtotal` decimal(10,2) DEFAULT NULL,
  `remarks` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='导入公积金信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='部门(公司)公积金模板';
...
CREATE TABLE `tb_hr_recruitment_applicant_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='应聘者信息';
...
CREATE TABLE `tb_hr_recruitment_information_neaten` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='招聘信息整理';
...
CREATE TABLE `tb_hr_recruitment_information_release` (
  ...
  `status` varchar(10) DEFAULT NULL COMMENT '流程状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='招聘信息发布';
...
CREATE TABLE `tb_hr_recruitment_information_release_detail` (
  ...
  `creator` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='招聘信息发布明细';
...
CREATE TABLE `tb_hr_salary_adjustment` (
  ...
  `bis_update` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工工资调整主 表';
...
CREATE TABLE `tb_hr_salary_adjustment_rank` (
  ...
  `kickback_performance` bit(1) DEFAULT b'0' COMMENT '是否回扣绩效工资',
  `internship_wage` bigint(20) DEFAULT NULL COMMENT '实习工资',
  `ote_that` varchar(1000) DEFAULT NULL,
  `post_amount` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_hr_salary_adjustment_user` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='本次调整人员信息表';
...
CREATE TABLE `tb_hr_salary_class` (
  ...
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='薪水类型';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='部门(公司)薪水模板';
...
CREATE TABLE `tb_hr_salary_user_achievements` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3313 DEFAULT CHARSET=utf8 COMMENT='老系统绩效工资';
...
CREATE TABLE `tb_hr_salary_user_achievements_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个人预发绩效记录';
...
CREATE TABLE `tb_hr_salary_user_achievements_history_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='预发绩效明细记录\r\n';
...
CREATE TABLE `tb_hr_salary_user_grant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工资发放表';
...
CREATE TABLE `tb_hr_salary_user_grant_list` (
  ...
  `costs_company` varchar(100) DEFAULT NULL,
  ...
  `costs_company_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工资发放明细表';
...
CREATE TABLE `tb_hr_salary_user_grant_nonpayment_list` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存放未缴纳社保公积金人员名单';
...
CREATE TABLE `tb_hr_salary_user_grant_pay` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工资发放';
...
CREATE TABLE `tb_hr_salary_user_grant_pay_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3427 DEFAULT CHARSET=utf8 COMMENT='工资发放名单明细';
...
CREATE TABLE `tb_hr_salary_user_grant_tax` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个税申报汇总';
...
CREATE TABLE `tb_hr_salary_user_grant_tax_deduction` (
  ...
  `bis_enable` bit(1) DEFAULT b'1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='人员专项扣除设置';
...
CREATE TABLE `tb_hr_salary_user_grant_tax_list` (
  ...
  `tax_rant` bigint(20) DEFAULT NULL COMMENT '税率',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个税申报数据';
...
CREATE TABLE `tb_hr_sick_leave_deduction_set` (
  ...
  `creator` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='病假扣减工资规则设置';
...
CREATE TABLE `tb_hr_social_security` (
  ...
  `master_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='导入社保信息';
...
CREATE TABLE `tb_hr_social_security_proportion` (
  ...
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统社保全局占比表';
...
CREATE TABLE `tb_hr_social_security_template` (
  ...
  PRIMARY KEY (`id`),
  KEY `template_department_id` (`department_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='部门(公司)社保模板';
...
CREATE TABLE `tb_hr_take_off_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='调休假记录';
...
CREATE TABLE `tb_hr_train_content_affirm` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训内容确认主表';
...
CREATE TABLE `tb_hr_train_content_affirm_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训内容确认项目信息明细表';
...
CREATE TABLE `tb_hr_train_content_affirm_detail_project` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训内容确认项目表';
...
CREATE TABLE `tb_hr_train_content_affirm_detail_sub` (
  ...
  `survey_detail_id` int(11) DEFAULT NULL COMMENT '绑定调查需求明细id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训内容确认会签意见表';
...
CREATE TABLE `tb_hr_train_courseware_examine` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='课件审查主表';
...
CREATE TABLE `tb_hr_train_courseware_examine_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='课件审查课程和教师明细表';
...
CREATE TABLE `tb_hr_train_courseware_examine_detail_sub` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='课件审查明细表';
...
CREATE TABLE `tb_hr_train_effect_evaluate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训效果评价表';
...
CREATE TABLE `tb_hr_train_external_achievement` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外部培训成果主表';
...
CREATE TABLE `tb_hr_train_external_achievement_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外部培训成果明细表';
...
CREATE TABLE `tb_hr_train_external_apply` (
  ...
  `total_period` bigint(10) DEFAULT NULL COMMENT '总学时',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外部培训申报主表';
...
CREATE TABLE `tb_hr_train_external_apply_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外部培训申报明细表';
...
CREATE TABLE `tb_hr_train_external_approval` (
  ...
  `train_batch_name` varchar(255) DEFAULT NULL COMMENT '培训批次名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外部培训审批主表';
...
CREATE TABLE `tb_hr_train_external_approval_detail` (
  ...
  `curriculum_nature_name` varchar(255) DEFAULT NULL COMMENT '课程性质名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外部培训审批明细表';
...
CREATE TABLE `tb_hr_train_inform` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训通知主表';
...
CREATE TABLE `tb_hr_train_inform_detail` (
  ...
  `evaluation_mode` varchar(255) DEFAULT NULL COMMENT '考核方式',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训通知明细表';
...
CREATE TABLE `tb_hr_train_needs_survey` (
  ...
  `modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训需求调查主表';
...
CREATE TABLE `tb_hr_train_needs_survey_detail` (
  ...
  `modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训需求调查明细表';
...
CREATE TABLE `tb_hr_train_needs_survey_detail_sub` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训需求调查会签意见表';
...
CREATE TABLE `tb_hr_train_plan` (
  ...
  `modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，记录变化后会自动更新时间戳',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训计划主表';
...
CREATE TABLE `tb_hr_train_plan_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训计划批次表';
...
CREATE TABLE `tb_hr_train_sign_in_spot_check` (
  ...
  `train_site` varchar(255) DEFAULT NULL COMMENT '培训地点',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训签到抽查主表';
...
CREATE TABLE `tb_hr_train_sign_in_spot_check_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训签到抽查明细表';
...
) ENGINE=InnoDB AUTO_INCREMENT=178 DEFAULT CHARSET=utf8 COMMENT='组织机构用户表';
...
CREATE TABLE `tb_hr_user_bankcard` (
  ...
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='员工银行卡信息';
...
CREATE TABLE `tb_hr_user_contacts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='联系人信息表';
...
CREATE TABLE `tb_hr_user_department_adjustment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跨部门调岗';
...
CREATE TABLE `tb_hr_user_education` (
  ...
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='员工教育背景';
...
CREATE TABLE `tb_hr_user_family` (
  ...
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工家庭成员表';
...
CREATE TABLE `tb_hr_user_formal` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='转正流程';
...
CREATE TABLE `tb_hr_user_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='员工本公司工作记录';
...
CREATE TABLE `tb_hr_user_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=175 DEFAULT CHARSET=utf8 COMMENT='员工个人基本信息表';
...
CREATE TABLE `tb_hr_user_insurance` (
  ...
  `created` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='保险缴费情况';
...
CREATE TABLE `tb_hr_user_post_adjustment` (
  ...
  `actual_position_id` int(11) DEFAULT NULL COMMENT '确认职级',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='平调或降职流程';
...
CREATE TABLE `tb_hr_user_promotion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='晋升流程';
...
CREATE TABLE `tb_hr_user_quit` (
  ...
  `quit_explain_name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='离职';
...
CREATE TABLE `tb_hr_user_quit_transfer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='员工离职交接';
...
CREATE TABLE `tb_hr_user_social_security_and_provident_fund` (
  ...
  `welfare_status` varchar(10) DEFAULT '' COMMENT '社保公积金状态',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工用户社保公积金信息录入';
...
CREATE TABLE `tb_hr_user_social_security_and_provident_fund_agents` (
  ...
  KEY `social_security_and_provident_fund_user_account` (`user_account`),
  KEY `user_social_security_template_id` (`template_id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='员工用户社保公积金代理(补缴、代缴)记录';
...
CREATE TABLE `tb_hr_user_welfare_change` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_process_inst_id` (`process_inst_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工福利(社保公积金)变更记录主表';
...
CREATE TABLE `tb_hr_user_welfare_change_detail` (
  ...
  KEY `index_user_account` (`user_account`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='员工福利(社保公积金)变更记录明细';
...
CREATE TABLE `tb_hr_user_work` (
  ...
  `creator` varchar(50) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='员工工作经历信息表';
...
CREATE TABLE `tb_hr_vacation_change_record` (
  ...
  `creator` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=706 DEFAULT CHARSET=utf8 COMMENT='调休及年假变化记录表';
...
CREATE TABLE `tb_hr_vacation_type` (
  ...
  `creator` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='假期类型管理';
...
CREATE TABLE `tb_hr_welfare_cardinality` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='社保公积金基数流程';
...
CREATE TABLE `tb_hr_welfare_cardinality_list` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='社保公积金基数人员明细';
...
CREATE TABLE `tb_hr_work_schedule_results` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='工作成果';
...
CREATE TABLE `tb_hr_work_shift_set` (
  ...
  `creator` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='上班时间设定';
...
CREATE TABLE `tb_hr_work_year_annual_leave_set` (
  ...
  `creator` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工龄与年假天数规则设置';
